...
{
    public class CarrierInsuranceOptionsManager : ICarrierInsuranceOptionsManager
    {
        private readonly ICarrierInsuranceOptionsDataAccess DataAccess = null;
        public CarrierInsuranceOptionsManager(ICarrierInsuranceOptionsDataAccess dataAccess)
        {
