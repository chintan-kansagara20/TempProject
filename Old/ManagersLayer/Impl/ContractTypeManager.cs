...
{
    public class ContractTypeManager : IContractTypeManager
    {
        private readonly IContractTypeDataAccess DataAccess = null;
        public ContractTypeManager(IContractTypeDataAccess dataAccess)
        {
