...
{
    public class CarrierBillingOptionsManager : ICarrierBillingOptionsManager
    {
        private readonly ICarrierBillingOptionsDataAccess DataAccess = null;
        public CarrierBillingOptionsManager(ICarrierBillingOptionsDataAccess dataAccess)
        {
