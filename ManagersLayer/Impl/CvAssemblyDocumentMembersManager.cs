...
{
    public class CvAssemblyDocumentMembersManager : ICvAssemblyDocumentMembersManager
    {
        private readonly ICvAssemblyDocumentMembersDataAccess DataAccess = null;
        public CvAssemblyDocumentMembersManager(ICvAssemblyDocumentMembersDataAccess dataAccess)
        {
