...
{
    public class BusinessActivityRelatedItemsManager : IBusinessActivityRelatedItemsManager
    {
        private readonly IBusinessActivityRelatedItemsDataAccess DataAccess = null;
        public BusinessActivityRelatedItemsManager(IBusinessActivityRelatedItemsDataAccess dataAccess)
        {
