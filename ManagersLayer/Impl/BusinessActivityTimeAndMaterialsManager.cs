...
{
    public class BusinessActivityTimeAndMaterialsManager : IBusinessActivityTimeAndMaterialsManager
    {
        private readonly IBusinessActivityTimeAndMaterialsDataAccess DataAccess = null;
        public BusinessActivityTimeAndMaterialsManager(IBusinessActivityTimeAndMaterialsDataAccess dataAccess)
        {
