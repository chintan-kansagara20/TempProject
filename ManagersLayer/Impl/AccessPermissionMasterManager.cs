...
{
    public class AccessPermissionMasterManager : IAccessPermissionMasterManager
    {
        private readonly IAccessPermissionMasterDataAccess DataAccess = null;
        public AccessPermissionMasterManager(IAccessPermissionMasterDataAccess dataAccess)
        {
