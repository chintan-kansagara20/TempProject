...
namespace CrystalData.DataAccess.Impl
{
    public class NotesDataAccess : INotesDataAccess
    {
        ...
        public NotesDataAccess(IHostingEnvironment env, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            try
            {
        ...
        public List<NotesModel> Get(int page, int itemsPerPage, List<OrderByModel> orderBy, List<AdvanceFilterByModel> filtersList)
        {
            ...
            var FinalReturn = _EC.GetList<NotesModel>(page, itemsPerPage, orderBy, WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return FinalReturn;
        }
        ...
        public int GetTotal(List<AdvanceFilterByModel> filtersList)
        {
            ...
            var total = _EC.Count<NotesModel>(WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return total;
        }
    }
}
