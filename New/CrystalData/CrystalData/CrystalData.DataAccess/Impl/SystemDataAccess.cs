...
namespace CrystalData.DataAccess.Impl
{
    public class SystemDataAccess : ISystemDataAccess
    {
        ...
        public SystemDataAccess(IHostingEnvironment env, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            try
            {
        ...
        public List<SystemModel> Get(int page, int itemsPerPage, List<OrderByModel> orderBy, List<AdvanceFilterByModel> filtersList)
        {
            ...
            var FinalReturn = _EC.GetList<SystemModel>(page, itemsPerPage, orderBy, WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return FinalReturn;
        }
        ...
        public int GetTotal(List<AdvanceFilterByModel> filtersList)
        {
            ...
            var total = _EC.Count<SystemModel>(WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return total;
        }
    }
}
