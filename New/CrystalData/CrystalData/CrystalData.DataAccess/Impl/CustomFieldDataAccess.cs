...
namespace CrystalData.DataAccess.Impl
{
    public class CustomFieldDataAccess : ICustomFieldDataAccess
    {
        ...
        public CustomFieldDataAccess(IHostingEnvironment env, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            try
            {
        ...
        public List<CustomFieldModel> Get(int page, int itemsPerPage, List<OrderByModel> orderBy, List<AdvanceFilterByModel> filtersList)
        {
            ...
            var FinalReturn = _EC.GetList<CustomFieldModel>(page, itemsPerPage, orderBy, WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return FinalReturn;
        }
        ...
        public int GetTotal(List<AdvanceFilterByModel> filtersList)
        {
            ...
            var total = _EC.Count<CustomFieldModel>(WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return total;
        }
    }
}
