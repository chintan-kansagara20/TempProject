...
namespace CrystalData.DataAccess.Impl
{
    public class CurrencyDataAccess : ICurrencyDataAccess
    {
        ...
        public CurrencyDataAccess(IHostingEnvironment env, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            try
            {
        ...
        public List<CurrencyModel> Get(int page, int itemsPerPage, List<OrderByModel> orderBy, List<AdvanceFilterByModel> filtersList)
        {
            ...
            var FinalReturn = _EC.GetList<CurrencyModel>(page, itemsPerPage, orderBy, WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return FinalReturn;
        }
        ...
        public int GetTotal(List<AdvanceFilterByModel> filtersList)
        {
            ...
            var total = _EC.Count<CurrencyModel>(WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return total;
        }
    }   
}