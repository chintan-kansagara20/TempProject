...
{
    public class LotSerialDefaultLocationManager : ILotSerialDefaultLocationManager
    {
        private readonly ILotSerialDefaultLocationDataAccess DataAccess = null;
        public LotSerialDefaultLocationManager(ILotSerialDefaultLocationDataAccess dataAccess)
        {
