...
{
    public class IssuePriorityCodeManager : IIssuePriorityCodeManager
    {
        private readonly IIssuePriorityCodeDataAccess DataAccess = null;
        public IssuePriorityCodeManager(IIssuePriorityCodeDataAccess dataAccess)
        {
