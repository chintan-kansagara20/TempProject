...
{
    public class TbAccessPermissionMasterManager : ITbAccessPermissionMasterManager
    {
        private readonly ITbAccessPermissionMasterDataAccess DataAccess = null;
        public TbAccessPermissionMasterManager(ITbAccessPermissionMasterDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbAccessPermissionMasterModel model)
        {
        ...
        public APIResponse Update(string Permission, tbAccessPermissionMasterModel model)
        {
            var result = DataAccess.Update(Permission, model);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse HardDelete(string Permission)
        {
            var result = DataAccess.HardDelete(Permission);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
