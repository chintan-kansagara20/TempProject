...
{
    public class CustomerExportManager : ICustomerExportManager
    {
        private readonly ICustomerExportDataAccess DataAccess = null;
        public CustomerExportManager(ICustomerExportDataAccess dataAccess)
        {
