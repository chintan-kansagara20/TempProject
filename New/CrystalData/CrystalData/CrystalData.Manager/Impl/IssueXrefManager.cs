...
{
    public class IssueXrefManager : IIssueXrefManager
    {
        private readonly IIssueXrefDataAccess DataAccess = null;
        public IssueXrefManager(IIssueXrefDataAccess dataAccess)
        {
