...
{
    public class UnpostedComponentLocationSummaryManager : IUnpostedComponentLocationSummaryManager
    {
        private readonly IUnpostedComponentLocationSummaryDataAccess DataAccess = null;
        public UnpostedComponentLocationSummaryManager(IUnpostedComponentLocationSummaryDataAccess dataAccess)
        {
