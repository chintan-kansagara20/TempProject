...
{
    public class TbBarcodeTypeManager : ITbBarcodeTypeManager
    {
        private readonly ITbBarcodeTypeDataAccess DataAccess = null;
        public TbBarcodeTypeManager(ITbBarcodeTypeDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbBarcodeTypeModel model)
        {
        ...
        public APIResponse Update(string BarcodeTypeID, tbBarcodeTypeModel model)
        {
            var result = DataAccess.Update(BarcodeTypeID, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(string BarcodeTypeID)
        {
            var result = DataAccess.HardDelete(BarcodeTypeID);
            if (result)
            {
