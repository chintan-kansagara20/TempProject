...
{
    public class EDIOrderDetailExManager : IEDIOrderDetailExManager
    {
        private readonly IEDIOrderDetailExDataAccess DataAccess = null;
        public EDIOrderDetailExManager(IEDIOrderDetailExDataAccess dataAccess)
        {
