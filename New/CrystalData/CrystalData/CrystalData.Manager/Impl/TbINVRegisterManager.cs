...
{
    public class TbINVRegisterManager : ITbINVRegisterManager
    {
        private readonly ITbINVRegisterDataAccess DataAccess = null;
        public TbINVRegisterManager(ITbINVRegisterDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbINVRegisterModel model)
        {
        ...
        public APIResponse Update(Guid GUIDINVRegister, tbINVRegisterModel model)
        {
            var result = DataAccess.Update(GUIDINVRegister, model);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse Delete(Guid GUIDINVRegister)
        {
            var result = DataAccess.VoidRecord(GUIDINVRegister);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse HardDelete(Guid GUIDINVRegister)
        {
            var result = DataAccess.HardDelete(GUIDINVRegister);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
