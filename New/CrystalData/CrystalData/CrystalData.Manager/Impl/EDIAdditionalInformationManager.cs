...
{
    public class EDIAdditionalInformationManager : IEDIAdditionalInformationManager
    {
        private readonly IEDIAdditionalInformationDataAccess DataAccess = null;
        public EDIAdditionalInformationManager(IEDIAdditionalInformationDataAccess dataAccess)
        {
