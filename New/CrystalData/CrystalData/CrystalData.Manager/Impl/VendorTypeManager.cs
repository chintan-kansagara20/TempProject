...
{
    public class VendorTypeManager : IVendorTypeManager
    {
        private readonly IVendorTypeDataAccess DataAccess = null;
        public VendorTypeManager(IVendorTypeDataAccess dataAccess)
        {
