...
{
    public class GLAccountSegmentManager : IGLAccountSegmentManager
    {
        private readonly IGLAccountSegmentDataAccess DataAccess = null;
        public GLAccountSegmentManager(IGLAccountSegmentDataAccess dataAccess)
        {
