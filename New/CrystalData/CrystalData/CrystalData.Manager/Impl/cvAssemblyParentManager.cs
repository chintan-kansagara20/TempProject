...
{
    public class cvAssemblyParentManager : IcvAssemblyParentManager
    {
        private readonly IcvAssemblyParentDataAccess DataAccess = null;
        public cvAssemblyParentManager(IcvAssemblyParentDataAccess dataAccess)
        {
