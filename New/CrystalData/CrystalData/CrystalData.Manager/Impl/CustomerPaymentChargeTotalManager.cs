...
{
    public class CustomerPaymentChargeTotalManager : ICustomerPaymentChargeTotalManager
    {
        private readonly ICustomerPaymentAppliedTotalDataAccess DataAccess = null;
        public CustomerPaymentChargeTotalManager(ICustomerPaymentAppliedTotalDataAccess dataAccess)
        {
