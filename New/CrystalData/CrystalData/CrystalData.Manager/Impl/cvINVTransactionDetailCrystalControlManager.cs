...
{
    public class cvINVTransactionDetailCrystalControlManager : IcvINVTransactionDetailCrystalControlManager
    {
        private readonly IcvINVTransactionDetailCrystalControlDataAccess DataAccess = null;
        public cvINVTransactionDetailCrystalControlManager(IcvINVTransactionDetailCrystalControlDataAccess dataAccess)
        {
