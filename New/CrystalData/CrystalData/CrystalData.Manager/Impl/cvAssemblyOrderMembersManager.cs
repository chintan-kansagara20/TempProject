...
{
    public class cvAssemblyOrderMembersManager : IcvAssemblyOrderMembersManager
    {
        private readonly IcvAssemblyOrderMembersDataAccess DataAccess = null;
        public cvAssemblyOrderMembersManager(IcvAssemblyOrderMembersDataAccess dataAccess)
        {
