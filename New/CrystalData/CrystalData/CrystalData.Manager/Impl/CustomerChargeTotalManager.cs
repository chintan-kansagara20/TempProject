...
{
    public class CustomerChargeTotalManager : ICustomerChargeTotalManager
    {
        private readonly ICustomerChargeTotalDataAccess DataAccess = null;
        public CustomerChargeTotalManager(ICustomerChargeTotalDataAccess dataAccess)
        {
