...
{
    public class JournalLineManager : IJournalLineManager
    {
        private readonly IJournalLineDataAccess DataAccess = null;
        public JournalLineManager(IJournalLineDataAccess dataAccess)
        {
