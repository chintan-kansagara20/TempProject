...
{
    public class LIFOCostLayersManager : ILIFOCostLayersManager
    {
        private readonly ILIFOCostLayersDataAccess DataAccess = null;
        public LIFOCostLayersManager(ILIFOCostLayersDataAccess dataAccess)
        {
