...
{
    public class UnpostedTransferLocationSummaryManager : IUnpostedTransferLocationSummaryManager
    {
        private readonly IUnpostedTransferLocationSummaryDataAccess DataAccess = null;
        public UnpostedTransferLocationSummaryManager(IUnpostedTransferLocationSummaryDataAccess dataAccess)
        {
