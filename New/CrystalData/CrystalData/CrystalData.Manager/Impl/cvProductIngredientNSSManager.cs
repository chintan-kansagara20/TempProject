...
{
    public class cvProductIngredientNSSManager : IcvProductIngredientNSSManager
    {
        private readonly IcvProductIngredientNSSDataAccess DataAccess = null;
        public cvProductIngredientNSSManager(IcvProductIngredientNSSDataAccess dataAccess)
        {
