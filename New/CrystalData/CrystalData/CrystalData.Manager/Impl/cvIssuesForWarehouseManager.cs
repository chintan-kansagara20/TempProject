...
{
    public class cvIssuesForWarehouseManager : IcvIssuesForWarehouseManager
    {
        private readonly IcvIssuesForWarehouseDataAccess DataAccess = null;
        public cvIssuesForWarehouseManager(IcvIssuesForWarehouseDataAccess dataAccess)
        {
