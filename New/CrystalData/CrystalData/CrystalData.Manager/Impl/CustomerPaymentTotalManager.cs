...
{
    public class CustomerPaymentTotalManager : ICustomerPaymentTotalManager
    {
        private readonly ICustomerPaymentTotalDataAccess DataAccess = null;
        public CustomerPaymentTotalManager(ICustomerPaymentTotalDataAccess dataAccess)
        {
