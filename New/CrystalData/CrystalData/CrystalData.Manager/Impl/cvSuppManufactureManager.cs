...
{
    public class cvSuppManufactureManager : IcvSuppManufactureManager
    {
        private readonly IcvSuppManufactureDataAccess DataAccess = null;
        public cvSuppManufactureManager(IcvSuppManufactureDataAccess dataAccess)
        {
