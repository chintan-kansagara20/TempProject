...
{
    public class IssueTypeStatusXrefManager : IIssueTypeStatusXrefManager
    {
        private readonly IIssueTypeStatusXrefDataAccess DataAccess = null;
        public IssueTypeStatusXrefManager(IIssueTypeStatusXrefDataAccess dataAccess)
        {
