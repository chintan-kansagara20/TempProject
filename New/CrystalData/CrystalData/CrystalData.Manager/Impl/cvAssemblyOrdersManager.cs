...
{
    public class cvAssemblyOrdersManager : IcvAssemblyOrdersManager
    {
        private readonly IcvAssemblyOrdersDataAccess DataAccess = null;
        public cvAssemblyOrdersManager(IcvAssemblyOrdersDataAccess dataAccess)
        {
