...
{
    public class ImportSourceRelateFieldsManager : IImportSourceRelateFieldsManager
    {
        private readonly IImportSourceRelateFieldsDataAccess DataAccess = null;
        public ImportSourceRelateFieldsManager(IImportSourceRelateFieldsDataAccess dataAccess)
        {
