...
{
    public class ProductSalesCategoryManager : IProductSalesCategoryManager
    {
        private readonly IProductSalesCategoryDataAccess DataAccess = null;
        public ProductSalesCategoryManager(IProductSalesCategoryDataAccess dataAccess)
        {
