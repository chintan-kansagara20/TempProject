...
{
    public class cvAccessGroupManager : IcvAccessGroupManager
    {
        private readonly IcvAccessGroupDataAccess DataAccess = null;
        public cvAccessGroupManager(IcvAccessGroupDataAccess dataAccess)
        {
