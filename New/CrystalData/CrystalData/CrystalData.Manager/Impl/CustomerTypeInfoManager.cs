...
{
    public class CustomerTypeInfoManager : ICustomerTypeInfoManager
    {
        private readonly ICustomerTypeInfoDataAccess DataAccess = null;
        public CustomerTypeInfoManager(ICustomerTypeInfoDataAccess dataAccess)
        {
