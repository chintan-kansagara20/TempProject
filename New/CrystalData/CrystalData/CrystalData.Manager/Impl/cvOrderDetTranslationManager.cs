...
{
    public class cvOrderDetTranslationManager : IcvOrderDetTranslationManager
    {
        private readonly IcvOrderDetTranslationDataAccess DataAccess = null;
        public cvOrderDetTranslationManager(IcvOrderDetTranslationDataAccess dataAccess)
        {
