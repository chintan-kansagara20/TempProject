...
{
    public class ProductAnalysisByMonthManager : IProductAnalysisByMonthManager
    {
        private readonly IProductAnalysisByMonthDataAccess DataAccess = null;
        public ProductAnalysisByMonthManager(IProductAnalysisByMonthDataAccess dataAccess)
        {
