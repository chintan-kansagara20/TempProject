...
{
    public class ImportTransformationManager : IImportTransformationManager
    {
        private readonly IImportTransformationDataAccess DataAccess = null;
        public ImportTransformationManager(IImportTransformationDataAccess dataAccess)
        {
