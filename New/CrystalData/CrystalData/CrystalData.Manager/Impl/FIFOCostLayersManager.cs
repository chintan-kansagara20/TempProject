...
{
    public class FIFOCostLayersManager : IFIFOCostLayersManager
    {
        private readonly IFIFOCostLayersDataAccess DataAccess = null;
        public FIFOCostLayersManager(IFIFOCostLayersDataAccess dataAccess)
        {
