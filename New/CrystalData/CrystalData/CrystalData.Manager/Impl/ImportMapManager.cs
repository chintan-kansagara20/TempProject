...
{
    public class ImportMapManager : IImportMapManager
    {
        private readonly IImportMapDataAccess DataAccess = null;
        public ImportMapManager(IImportMapDataAccess dataAccess)
        {
