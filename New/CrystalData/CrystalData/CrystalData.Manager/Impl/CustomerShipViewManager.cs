...
{
    public class CustomerShipViewManager : ICustomerShipViewManager
    {
        private readonly ICustomerShipViewDataAccess DataAccess = null;
        public CustomerShipViewManager(ICustomerShipViewDataAccess dataAccess)
        {
