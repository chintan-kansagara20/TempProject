...
{
    public class CustomerPaymentViewManager : ICustomerPaymentViewManager
    {
        private readonly ICustomerPaymentViewDataAccess DataAccess = null;
        public CustomerPaymentViewManager(ICustomerPaymentViewDataAccess dataAccess)
        {
