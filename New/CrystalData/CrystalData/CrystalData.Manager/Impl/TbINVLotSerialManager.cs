...
{
    public class TbINVLotSerialManager : ITbINVLotSerialManager
    {
        private readonly ITbINVLotSerialDataAccess DataAccess = null;
        public TbINVLotSerialManager(ITbINVLotSerialDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbINVLotSerialModel model)
        {
        ...
        public APIResponse Update(Guid GUIDINVLotSerial, tbINVLotSerialModel model)
        {
            var result = DataAccess.Update(GUIDINVLotSerial, model);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse HardDelete(Guid GUIDINVLotSerial)
        {
            var result = DataAccess.HardDelete(GUIDINVLotSerial);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
