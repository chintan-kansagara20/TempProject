...
{
    public class cvProductComponentManager : IcvProductComponentManager
    {
        private readonly IcvProductComponentDataAccess DataAccess = null;
        public cvProductComponentManager(IcvProductComponentDataAccess dataAccess)
        {
