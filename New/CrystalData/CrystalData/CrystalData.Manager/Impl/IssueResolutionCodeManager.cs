...
{
    public class IssueResolutionCodeManager : IIssueResolutionCodeManager
    {
        private readonly IIssueResolutionCodeDataAccess DataAccess = null;
        public IssueResolutionCodeManager(IIssueResolutionCodeDataAccess dataAccess)
        {
