...
{
    public class TbEDIPartnerTransactionManager : ITbEDIPartnerTransactionManager
    {
        private readonly ITbEDIPartnerTransactionDataAccess DataAccess = null;
        public TbEDIPartnerTransactionManager(ITbEDIPartnerTransactionDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbEDIPartnerTransactionModel model)
        {
        ...
        public APIResponse Update(Guid GUIDPartnerTransaction, tbEDIPartnerTransactionModel model)
        {
            var result = DataAccess.Update(GUIDPartnerTransaction, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(Guid GUIDPartnerTransaction)
        {
            var result = DataAccess.HardDelete(GUIDPartnerTransaction);
            if (result)
            {
