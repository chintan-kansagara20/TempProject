...
{
    public class cvIssueViewersAssembliesManager : IcvIssueViewersAssembliesManager
    {
        private readonly IcvIssueViewersAssembliesDataAccess DataAccess = null;
        public cvIssueViewersAssembliesManager(IcvIssueViewersAssembliesDataAccess dataAccess)
        {
