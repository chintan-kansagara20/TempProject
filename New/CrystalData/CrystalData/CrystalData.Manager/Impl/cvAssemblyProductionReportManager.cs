...
{
    public class cvAssemblyProductionReportManager : IcvAssemblyProductionReportManager
    {
        private readonly IcvAssemblyProductionReportDataAccess DataAccess = null;
        public cvAssemblyProductionReportManager(IcvAssemblyProductionReportDataAccess dataAccess)
        {
