...
{
    public class ShipmentOrderSummaryManager : IShipmentOrderSummaryManager
    {
        private readonly IShipmentOrderSummaryDataAccess DataAccess = null;
        public ShipmentOrderSummaryManager(IShipmentOrderSummaryDataAccess dataAccess)
        {
