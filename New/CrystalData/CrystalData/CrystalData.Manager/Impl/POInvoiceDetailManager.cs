...
{
    public class POInvoiceDetailManager : IPOInvoiceDetailManager
    {
        private readonly IPOInvoiceDetailDataAccess DataAccess = null;
        public POInvoiceDetailManager(IPOInvoiceDetailDataAccess dataAccess)
        {
