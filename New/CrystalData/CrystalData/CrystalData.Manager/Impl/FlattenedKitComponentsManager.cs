...
{
    public class FlattenedKitComponentsManager : IFlattenedKitComponentsManager
    {
        private readonly IFlattenedKitComponentsDataAccess DataAccess = null;
        public FlattenedKitComponentsManager(IFlattenedKitComponentsDataAccess dataAccess)
        {
