...
{
    public class cvReceivingLogManager : IcvReceivingLogManager
    {
        private readonly IcvReceivingLogDataAccess DataAccess = null;
        public cvReceivingLogManager(IcvReceivingLogDataAccess dataAccess)
        {
