...
{
    public class IssueTypeSchedulingClassXrefManager : IIssueTypeSchedulingClassXrefManager
    {
        private readonly IIssueTypeSchedulingClassXrefDataAccess DataAccess = null;
        public IssueTypeSchedulingClassXrefManager(IIssueTypeSchedulingClassXrefDataAccess dataAccess)
        {
