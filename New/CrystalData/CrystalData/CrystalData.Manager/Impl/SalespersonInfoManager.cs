...
{
    public class SalespersonInfoManager : ISalespersonInfoManager
    {
        private readonly ISalespersonInfoDataAccess DataAccess = null;
        public SalespersonInfoManager(ISalespersonInfoDataAccess dataAccess)
        {
