...
{
    public class TbCustomerManager : ITbCustomerManager
    {
        private readonly ITbCustomerDataAccess DataAccess = null;
        public TbCustomerManager(ITbCustomerDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbCustomerModel model)
        {
        ...
        public APIResponse Update(Guid GUIDCustomer, tbCustomerModel model)
        {
