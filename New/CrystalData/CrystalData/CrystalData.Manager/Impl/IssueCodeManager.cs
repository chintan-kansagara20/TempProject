...
{
    public class IssueCodeManager : IIssueCodeManager
    {
        private readonly IIssueCodeDataAccess DataAccess = null;
        public IssueCodeManager(IIssueCodeDataAccess dataAccess)
        {
