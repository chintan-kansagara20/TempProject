...
{
    public class cvAssemblyOrderDetManager : IcvAssemblyOrderDetManager
    {
        private readonly IcvAssemblyOrderDetDataAccess DataAccess = null;
        public cvAssemblyOrderDetManager(IcvAssemblyOrderDetDataAccess dataAccess)
        {
