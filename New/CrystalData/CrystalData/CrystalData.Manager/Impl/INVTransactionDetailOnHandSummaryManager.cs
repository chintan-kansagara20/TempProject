...
{
    public class INVTransactionDetailOnHandSummaryManager : IINVTransactionDetailOnHandSummaryManager
    {
        private readonly IINVTransactionDetailOnHandSummaryDataAccess DataAccess = null;
        public INVTransactionDetailOnHandSummaryManager(IINVTransactionDetailOnHandSummaryDataAccess dataAccess)
        {
