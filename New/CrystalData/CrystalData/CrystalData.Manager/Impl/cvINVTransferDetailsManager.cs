...
{
    public class cvINVTransferDetailsManager : IcvINVTransferDetailsManager
    {
        private readonly IcvINVTransferDetailsDataAccess DataAccess = null;
        public cvINVTransferDetailsManager(IcvINVTransferDetailsDataAccess dataAccess)
        {
