...
{
    public class IssueLogManager : IIssueLogManager
    {
        private readonly IIssueLogDataAccess DataAccess = null;
        public IssueLogManager(IIssueLogDataAccess dataAccess)
        {
