...
{
    public class cvLinkConfigLabelsManager : IcvLinkConfigLabelsManager
    {
        private readonly IcvLinkConfigLabelsDataAccess DataAccess = null;
        public cvLinkConfigLabelsManager(IcvLinkConfigLabelsDataAccess dataAccess)
        {
