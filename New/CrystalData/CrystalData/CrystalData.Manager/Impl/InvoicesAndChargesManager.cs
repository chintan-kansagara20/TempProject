...
{
    public class InvoicesAndChargesManager : IInvoicesAndChargesManager
    {
        private readonly IInvoicesAndChargesDataAccess DataAccess = null;
        public InvoicesAndChargesManager(IInvoicesAndChargesDataAccess dataAccess)
        {
