...
{
    public class cvProductQCManager : IcvProductQCManager
    {
        private readonly IcvProductQCDataAccess DataAccess = null;
        public cvProductQCManager(IcvProductQCDataAccess dataAccess)
        {
