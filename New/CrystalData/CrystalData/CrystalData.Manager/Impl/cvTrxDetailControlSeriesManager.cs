...
{
    public class cvTrxDetailControlSeriesManager : IcvTrxDetailControlSeriesManager
    {
        private readonly IcvTrxDetailControlSeriesDataAccess DataAccess = null;
        public cvTrxDetailControlSeriesManager(IcvTrxDetailControlSeriesDataAccess dataAccess)
        {
