...
{
    public class PODetailReceiptSummaryManager : IPODetailReceiptSummaryManager
    {
        private readonly IPODetailReceiptSummaryDataAccess DataAccess = null;
        public PODetailReceiptSummaryManager(IPODetailReceiptSummaryDataAccess dataAccess)
        {
