...
{
    public class PriceCodeManager : IPriceCodeManager
    {
        private readonly IPriceCodeDataAccess DataAccess = null;
        public PriceCodeManager(IPriceCodeDataAccess dataAccess)
        {
