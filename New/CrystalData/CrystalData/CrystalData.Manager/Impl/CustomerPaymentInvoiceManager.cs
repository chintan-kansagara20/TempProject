...
{
    public class CustomerPaymentInvoiceManager : ICustomerPaymentInvoiceManager
    {
        private readonly ICustomerPaymentInvoiceDataAccess DataAccess = null;
        public CustomerPaymentInvoiceManager(ICustomerPaymentInvoiceDataAccess dataAccess)
        {
