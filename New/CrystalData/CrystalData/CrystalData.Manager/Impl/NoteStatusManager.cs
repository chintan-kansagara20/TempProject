...
{
    public class NoteStatusManager : INoteStatusManager
    {
        private readonly INoteStatusDataAccess DataAccess = null;
        public NoteStatusManager(INoteStatusDataAccess dataAccess)
        {
