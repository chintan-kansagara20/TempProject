...
{
    public class cvPODetWithReceiptsAssyNeededManager : IcvPODetWithReceiptsAssyNeededManager
    {
        private readonly IcvPODetWithReceiptsAssyNeededDataAccess DataAccess = null;
        public cvPODetWithReceiptsAssyNeededManager(IcvPODetWithReceiptsAssyNeededDataAccess dataAccess)
        {
