...
{
    public class NotesViewManager : INotesViewManager
    {
        private readonly INotesViewDataAccess DataAccess = null;
        public NotesViewManager(INotesViewDataAccess dataAccess)
        {
