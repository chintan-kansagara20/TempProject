...
{
    public class CvAssemblyDetailsManager : ICvAssemblyDetailsManager
    {
        private readonly ICvAssemblyDetailsDataAccess DataAccess = null;
        public CvAssemblyDetailsManager(ICvAssemblyDetailsDataAccess dataAccess)
        {
