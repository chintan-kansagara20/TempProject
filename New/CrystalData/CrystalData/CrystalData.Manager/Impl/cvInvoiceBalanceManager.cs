...
{
    public class cvInvoiceBalanceManager : IcvInvoiceBalanceManager
    {
        private readonly IcvInvoiceBalanceDataAccess DataAccess = null;
        public cvInvoiceBalanceManager(IcvInvoiceBalanceDataAccess dataAccess)
        {
