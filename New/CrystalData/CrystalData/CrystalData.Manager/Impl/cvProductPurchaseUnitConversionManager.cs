...
{
    public class cvProductPurchaseUnitConversionManager : IcvProductPurchaseUnitConversionManager
    {
        private readonly IcvProductPurchaseUnitConversionDataAccess DataAccess = null;
        public cvProductPurchaseUnitConversionManager(IcvProductPurchaseUnitConversionDataAccess dataAccess)
        {
