...
{
    public class cvPOReceiptManager : IcvPOReceiptManager
    {
        private readonly IcvPOReceiptDataAccess DataAccess = null;
        public cvPOReceiptManager(IcvPOReceiptDataAccess dataAccess)
        {
