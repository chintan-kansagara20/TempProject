...
{
    public class LotSerialInventoryManager : ILotSerialInventoryManager
    {
        private readonly ILotSerialInventoryDataAccess DataAccess = null;
        public LotSerialInventoryManager(ILotSerialInventoryDataAccess dataAccess)
        {
