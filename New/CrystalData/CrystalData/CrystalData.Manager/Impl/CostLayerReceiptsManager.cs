...
{
    public class CostLayerReceiptsManager : ICostLayerReceiptsManager
    {
        private readonly ICostLayerReceiptsDataAccess DataAccess = null;
        public CostLayerReceiptsManager(ICostLayerReceiptsDataAccess dataAccess)
        {
