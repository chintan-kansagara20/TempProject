...
{
    public class ShipmentOrderDetailManager : IShipmentOrderDetailManager
    {
        private readonly IShipmentOrderDetailDataAccess DataAccess = null;
        public ShipmentOrderDetailManager(IShipmentOrderDetailDataAccess dataAccess)
        {
