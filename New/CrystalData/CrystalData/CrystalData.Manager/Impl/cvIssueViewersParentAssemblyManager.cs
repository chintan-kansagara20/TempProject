...
{
    public class cvIssueViewersParentAssemblyManager : IcvIssueViewersParentAssemblyManager
    {
        private readonly IcvIssueViewersParentAssemblyDataAccess DataAccess = null;
        public cvIssueViewersParentAssemblyManager(IcvIssueViewersParentAssemblyDataAccess dataAccess)
        {
