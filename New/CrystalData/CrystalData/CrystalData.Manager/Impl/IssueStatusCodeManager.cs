...
{
    public class IssueStatusCodeManager : IIssueStatusCodeManager
    {
        private readonly IIssueStatusCodeDataAccess DataAccess = null;
        public IssueStatusCodeManager(IIssueStatusCodeDataAccess dataAccess)
        {
