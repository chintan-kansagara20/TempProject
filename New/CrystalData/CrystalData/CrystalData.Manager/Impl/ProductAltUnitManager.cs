...
{
    public class ProductAltUnitManager : IProductAltUnitManager
    {
        private readonly IProductAltUnitDataAccess DataAccess = null;
        public ProductAltUnitManager(IProductAltUnitDataAccess dataAccess)
        {
