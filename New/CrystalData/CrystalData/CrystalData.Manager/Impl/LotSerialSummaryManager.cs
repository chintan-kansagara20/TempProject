...
{
    public class LotSerialSummaryManager : ILotSerialSummaryManager
    {
        private readonly ILotSerialSummaryDataAccess DataAccess = null;
        public LotSerialSummaryManager(ILotSerialSummaryDataAccess dataAccess)
        {
