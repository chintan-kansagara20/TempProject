...
{
    public class ProductWarehouseLocationManager : IProductWarehouseLocationManager
    {
        private readonly IProductWarehouseLocationDataAccess DataAccess = null;
        public ProductWarehouseLocationManager(IProductWarehouseLocationDataAccess dataAccess)
        {
