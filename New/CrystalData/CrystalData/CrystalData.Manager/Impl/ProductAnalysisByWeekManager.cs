...
{
    public class ProductAnalysisByWeekManager : IProductAnalysisByWeekManager
    {
        private readonly IProductAnalysisByWeekDataAccess DataAccess = null;
        public ProductAnalysisByWeekManager(IProductAnalysisByWeekDataAccess dataAccess)
        {
