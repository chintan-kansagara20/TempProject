...
{
    public class TaxCatDefinitionManager : ITaxCatDefinitionManager
    {
        private readonly ITaxCatDefinitionDataAccess DataAccess = null;
        public TaxCatDefinitionManager(ITaxCatDefinitionDataAccess dataAccess)
        {
