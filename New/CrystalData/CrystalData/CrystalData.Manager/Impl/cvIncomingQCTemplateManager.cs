...
{
    public class cvIncomingQCTemplateManager : IcvIncomingQCTemplateManager
    {
        private readonly IcvIncomingQCTemplateDataAccess DataAccess = null;
        public cvIncomingQCTemplateManager(IcvIncomingQCTemplateDataAccess dataAccess)
        {
