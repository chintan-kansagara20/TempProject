...
{
    public class OrdersAvailableToShipManager : IOrdersAvailableToShipManager
    {
        private readonly IOrdersAvailableToShipDataAccess DataAccess = null;
        public OrdersAvailableToShipManager(IOrdersAvailableToShipDataAccess dataAccess)
        {
