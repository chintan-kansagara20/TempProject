...
{
    public class ProductWarehouseReorderManager : IProductWarehouseReorderManager
    {
        private readonly IProductWarehouseReorderDataAccess DataAccess = null;
        public ProductWarehouseReorderManager(IProductWarehouseReorderDataAccess dataAccess)
        {
