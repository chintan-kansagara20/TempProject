...
{
    public class ImportErrorsManager : IImportErrorsManager
    {
        private readonly IImportErrorsDataAccess DataAccess = null;
        public ImportErrorsManager(IImportErrorsDataAccess dataAccess)
        {
