...
{
    public class ShipToCommentsManager : IShipToCommentsManager
    {
        private readonly IShipToCommentsDataAccess DataAccess = null;
        public ShipToCommentsManager(IShipToCommentsDataAccess dataAccess)
        {
