...
{
    public class YearMonthManager : IYearMonthManager
    {
        private readonly IYearMonthDataAccess DataAccess = null;
        public YearMonthManager(IYearMonthDataAccess dataAccess)
        {
