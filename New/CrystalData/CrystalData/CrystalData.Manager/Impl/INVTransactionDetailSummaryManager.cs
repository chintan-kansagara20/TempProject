...
{
    public class INVTransactionDetailSummaryManager : IINVTransactionDetailSummaryManager
    {
        private readonly IINVTransactionDetailSummaryDataAccess DataAccess = null;
        public INVTransactionDetailSummaryManager(IINVTransactionDetailSummaryDataAccess dataAccess)
        {
