...
{
    public class InventoryJournalDetailManager : IInventoryJournalDetailManager
    {
        private readonly IInventoryJournalDetailDataAccess DataAccess = null;
        public InventoryJournalDetailManager(IInventoryJournalDetailDataAccess dataAccess)
        {
