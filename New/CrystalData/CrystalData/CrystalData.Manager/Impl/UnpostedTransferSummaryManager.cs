...
{
    public class UnpostedTransferSummaryManager : IUnpostedTransferSummaryManager
    {
        private readonly IUnpostedTransferSummaryDataAccess DataAccess = null;
        public UnpostedTransferSummaryManager(IUnpostedTransferSummaryDataAccess dataAccess)
        {
