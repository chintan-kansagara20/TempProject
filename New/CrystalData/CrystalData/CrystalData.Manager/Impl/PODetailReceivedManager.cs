...
{
    public class PODetailReceivedManager : IPODetailReceivedManager
    {
        private readonly IPODetailReceivedDataAccess DataAccess = null;
        public PODetailReceivedManager(IPODetailReceivedDataAccess dataAccess)
        {
