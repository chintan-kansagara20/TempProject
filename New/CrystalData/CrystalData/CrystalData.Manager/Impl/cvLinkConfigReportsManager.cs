...
{
    public class cvLinkConfigReportsManager : IcvLinkConfigReportsManager
    {
        private readonly IcvLinkConfigReportsDataAccess DataAccess = null;
        public cvLinkConfigReportsManager(IcvLinkConfigReportsDataAccess dataAccess)
        {
