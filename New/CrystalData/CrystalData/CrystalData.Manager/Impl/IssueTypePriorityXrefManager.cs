...
{
   public class IssueTypePriorityXrefManager : IIssueTypePriorityXrefManager
    {
        private readonly IIssueTypePriorityXrefDataAccess DataAccess = null;
        public IssueTypePriorityXrefManager(IIssueTypePriorityXrefDataAccess dataAccess)
        {
