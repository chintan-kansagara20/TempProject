...
{
    public class ProductClassManager : IProductClassManager
    {
        private readonly IProductClassDataAccess DataAccess = null;
        public ProductClassManager(IProductClassDataAccess dataAccess)
        {
