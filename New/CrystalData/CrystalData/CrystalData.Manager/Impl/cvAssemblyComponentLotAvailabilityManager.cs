...
{
    public class cvAssemblyComponentLotAvailabilityManager : IcvAssemblyComponentLotAvailabilityManager
    {
        private readonly IcvAssemblyComponentLotAvailabilityDataAccess DataAccess = null;
        public cvAssemblyComponentLotAvailabilityManager(IcvAssemblyComponentLotAvailabilityDataAccess dataAccess)
        {
