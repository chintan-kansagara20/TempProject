...
{
    public class cvPureFishComponentsForFGOrdersManager : IcvPureFishComponentsForFGOrdersManager
    {
        private readonly IcvPureFishComponentsForFGOrdersDataAccess DataAccess = null;
        public cvPureFishComponentsForFGOrdersManager(IcvPureFishComponentsForFGOrdersDataAccess dataAccess)
        {
