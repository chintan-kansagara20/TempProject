...
{
    public class cvIssueChangedAssignmentManager : IcvIssueChangedAssignmentManager
    {
        private readonly IcvIssueChangedAssignmentDataAccess DataAccess = null;
        public cvIssueChangedAssignmentManager(IcvIssueChangedAssignmentDataAccess dataAccess)
        {
