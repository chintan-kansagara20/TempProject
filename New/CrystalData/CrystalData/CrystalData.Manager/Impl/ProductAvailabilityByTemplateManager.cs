...
{
    public class ProductAvailabilityByTemplateManager : IProductAvailabilityByTemplateManager
    {
        private readonly IProductAvailabilityByTemplateDataAccess DataAccess = null;
        public ProductAvailabilityByTemplateManager(IProductAvailabilityByTemplateDataAccess dataAccess)
        {
