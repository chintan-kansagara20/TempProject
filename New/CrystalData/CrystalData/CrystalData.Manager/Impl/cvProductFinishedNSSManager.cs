...
{
    public class cvProductFinishedNSSManager : IcvProductFinishedNSSManager
    {
        private readonly IcvProductFinishedNSSDataAccess DataAccess = null;
        public cvProductFinishedNSSManager(IcvProductFinishedNSSDataAccess dataAccess)
        {
