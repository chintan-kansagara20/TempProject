...
{
    public class ImportSourceFileManager : IImportSourceFileManager
    {
        private readonly IImportSourceFileDataAccess DataAccess = null;
        public ImportSourceFileManager(IImportSourceFileDataAccess dataAccess)
        {
