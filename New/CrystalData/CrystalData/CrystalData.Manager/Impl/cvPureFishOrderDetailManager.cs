...
{
    public class cvPureFishOrderDetailManager : IcvPureFishOrderDetailManager
    {
        private readonly IcvPureFishOrderDetailDataAccess DataAccess = null;
        public cvPureFishOrderDetailManager(IcvPureFishOrderDetailDataAccess dataAccess)
        {
