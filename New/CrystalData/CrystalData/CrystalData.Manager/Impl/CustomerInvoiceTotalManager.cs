...
{
    public class CustomerInvoiceTotalManager : ICustomerInvoiceTotalManager
    {
        private readonly ICustomerInvoiceTotalDataAccess DataAccess = null;
        public CustomerInvoiceTotalManager(ICustomerInvoiceTotalDataAccess dataAccess)
        {
