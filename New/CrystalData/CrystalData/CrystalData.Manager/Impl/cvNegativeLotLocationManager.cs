...
{
    public class cvNegativeLotLocationManager : IcvNegativeLotLocationManager
    {
        private readonly IcvNegativeLotLocationDataAccess DataAccess = null;
        public cvNegativeLotLocationManager(IcvNegativeLotLocationDataAccess dataAccess)
        {
