...
{
    public class cvLastPOForProductManager : IcvLastPOForProductManager
    {
        private readonly IcvLastPOForProductDataAccess DataAccess = null;
        public cvLastPOForProductManager(IcvLastPOForProductDataAccess dataAccess)
        {
