...
{
    public class TbCustomerShipToInfoManager : ITbCustomerShipToInfoManager
    {
        private readonly ITbCustomerShipToInfoDataAccess DataAccess = null;
        public TbCustomerShipToInfoManager(ITbCustomerShipToInfoDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbCustomerShipToInfoModel model)
        {
        ...
        public APIResponse Update(Guid GUIDLocation, tbCustomerShipToInfoModel model)
        {
            var result = DataAccess.Update(GUIDLocation, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(Guid GUIDLocation)
        {
            var result = DataAccess.HardDelete(GUIDLocation);
            if (result)
            {
