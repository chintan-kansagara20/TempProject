...
{
    public class cvProductProcManager : IcvProductProcManager
    {
        private readonly IcvProductProcDataAccess DataAccess = null;
        public cvProductProcManager(IcvProductProcDataAccess dataAccess)
        {
