...
{
    public class cvAssemblyOrderDetailSummaryManager : IcvAssemblyOrderDetailSummaryManager
    {
        private readonly IcvAssemblyOrderDetailSummaryDataAccess DataAccess = null;
        public cvAssemblyOrderDetailSummaryManager(IcvAssemblyOrderDetailSummaryDataAccess dataAccess)
        {
