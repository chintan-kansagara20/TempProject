...
{
    public class ImportSkippedManager : IImportSkippedManager
    {
        private readonly IImportSkippedDataAccess DataAccess = null;
        public ImportSkippedManager(IImportSkippedDataAccess dataAccess)
        {
