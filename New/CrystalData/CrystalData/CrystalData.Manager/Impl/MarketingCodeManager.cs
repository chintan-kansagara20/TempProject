...
{
    public class MarketingCodeManager : IMarketingCodeManager
    {
        private readonly IMarketingCodeDataAccess DataAccess = null;
        public MarketingCodeManager(IMarketingCodeDataAccess dataAccess)
        {
