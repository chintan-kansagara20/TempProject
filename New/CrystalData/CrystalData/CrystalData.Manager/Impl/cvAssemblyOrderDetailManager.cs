...
{
    public class cvAssemblyOrderDetailManager : IcvAssemblyOrderDetailManager
    {
        private readonly IcvAssemblyOrderDetailDataAccess DataAccess = null;
        public cvAssemblyOrderDetailManager(IcvAssemblyOrderDetailDataAccess dataAccess)
        {
