...
{
    public class InventoryJournalManager : IInventoryJournalManager
    {
        private readonly IInventoryJournalDataAccess DataAccess = null;
        public InventoryJournalManager(IInventoryJournalDataAccess dataAccess)
        {
