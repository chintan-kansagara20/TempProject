...
{
    public class INVLotSerialTraceManager : IINVLotSerialTraceManager
    {
        private readonly IINVLotSerialTraceDataAccess DataAccess = null;
        public INVLotSerialTraceManager(IINVLotSerialTraceDataAccess dataAccess)
        {
