...
{
    public class cvLocationSummaryManager : IcvLocationSummaryManager
    {
        private readonly IcvLocationSummaryDataAccess DataAccess = null;
        public cvLocationSummaryManager(IcvLocationSummaryDataAccess dataAccess)
        {
