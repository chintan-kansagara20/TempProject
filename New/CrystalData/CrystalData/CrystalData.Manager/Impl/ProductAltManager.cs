...
{
    public class ProductAltManager : IProductAltManager
    {
        private readonly IProductAltDataAccess DataAccess = null;
        public ProductAltManager(IProductAltDataAccess dataAccess)
        {
