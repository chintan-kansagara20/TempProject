...
{
    public class cvNegativeLotLocationNAHSManager : IcvNegativeLotLocationNAHSManager
    {
        private readonly IcvNegativeLotLocationNAHSDataAccess DataAccess = null;
        public cvNegativeLotLocationNAHSManager(IcvNegativeLotLocationNAHSDataAccess dataAccess)
        {
