...
{
    public class INVRegisterManager : IINVRegisterManager
    {
        private readonly IINVRegisterDataAccess DataAccess = null;
        public INVRegisterManager(IINVRegisterDataAccess dataAccess)
        {
