...
{
    public class cvProductSpecAssembliesManager : IcvProductSpecAssembliesManager
    {
        private readonly IcvProductSpecAssembliesDataAccess DataAccess = null;
        public cvProductSpecAssembliesManager(IcvProductSpecAssembliesDataAccess dataAccess)
        {
