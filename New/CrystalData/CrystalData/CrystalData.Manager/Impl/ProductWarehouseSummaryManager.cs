...
{
    public class ProductWarehouseSummaryManager : IProductWarehouseSummaryManager
    {
        private readonly IProductWarehouseSummaryDataAccess DataAccess = null;
        public ProductWarehouseSummaryManager(IProductWarehouseSummaryDataAccess dataAccess)
        {
