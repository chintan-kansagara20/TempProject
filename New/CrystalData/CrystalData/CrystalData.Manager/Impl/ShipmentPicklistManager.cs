...
{
    public class ShipmentPicklistManager : IShipmentPicklistManager
    {
        private readonly IShipmentPicklistDataAccess DataAccess = null;
        public ShipmentPicklistManager(IShipmentPicklistDataAccess dataAccess)
        {
