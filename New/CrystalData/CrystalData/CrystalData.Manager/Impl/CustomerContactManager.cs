...
{
    public class CustomerContactManager : ICustomerContactManager
    {
        private readonly ICustomerContactDataAccess DataAccess = null;
        public CustomerContactManager(ICustomerContactDataAccess dataAccess)
        {
