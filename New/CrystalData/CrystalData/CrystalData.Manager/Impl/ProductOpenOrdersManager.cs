...
{
    public class ProductOpenOrdersManager : IProductOpenOrdersManager
    {
        private readonly IProductOpenOrdersDataAccess DataAccess = null;
        public ProductOpenOrdersManager(IProductOpenOrdersDataAccess dataAccess)
        {
