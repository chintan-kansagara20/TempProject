...
{
    public class LostBusinessManager : ILostBusinessManager
    {
        private readonly ILostBusinessDataAccess DataAccess = null;
        public LostBusinessManager(ILostBusinessDataAccess dataAccess)
        {
