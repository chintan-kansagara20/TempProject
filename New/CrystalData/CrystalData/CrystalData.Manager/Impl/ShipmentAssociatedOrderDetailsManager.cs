...
{
    public class ShipmentAssociatedOrderDetailsManager : IShipmentAssociatedOrderDetailsManager
    {
        private readonly IShipmentAssociatedOrderDetailsDataAccess DataAccess = null;
        public ShipmentAssociatedOrderDetailsManager(IShipmentAssociatedOrderDetailsDataAccess dataAccess)
        {
