...
{
    [Table("InventoryJournalDetail")]
    public class InventoryJournalDetailModel
    {
        ...
        public string CurrentDebitAccount { get; set; }
        public string CurrentCreditAccount { get; set; }
    }
}
