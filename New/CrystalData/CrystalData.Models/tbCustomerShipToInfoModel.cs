...
{
    [Table("tbCustomerShipToInfo")]
    public class tbCustomerShipToInfoModel
    {
        ...
        public Boolean HoldShipments { get; set; } = true;
        ...
        public Boolean IsDistributionCenter { get; set; } = true;
