...
{
    public class CvAssembliesDataAccess : ICvAssembliesDataAccess
    {
        private string ConnectionString { get; set; }

        private CommonFunctions cf { get; set; }
        public CvAssembliesDataAccess(IHostingEnvironment env, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            try
            {
        ...
        public List<cvAssembliesModel> Get(int page, int itemsPerPage, List<OrderByModel> orderBy, List<AdvanceFilterByModel> filtersList)
        {
            ...
            var FinalReturn = _EC.GetList<cvAssembliesModel>(page, itemsPerPage, orderBy, WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return FinalReturn;
        }
