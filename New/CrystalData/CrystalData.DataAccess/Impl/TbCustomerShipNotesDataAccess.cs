...
{
    public class TbCustomerShipNotesDataAccess : ITbCustomerShipNotesDataAccess
    {
        private string ConnectionString { get; set; }
        private CommonFunctions cf { get; set; }
        private IUserManager _UserManager { get; set; }

        public TbCustomerShipNotesDataAccess(IHostingEnvironment env, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IUserManager UserManager)
        {
            try
            {
        ...
        public List<tbCustomerShipNotesModel> Get(int page, int itemsPerPage, List<OrderByModel> orderBy, List<AdvanceFilterByModel> filtersList)
        {
            ...
            var FinalReturn = _EC.GetList<tbCustomerShipNotesModel>(page, itemsPerPage, orderBy, WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return FinalReturn;
        }
        ...
        public int GetTotal(List<AdvanceFilterByModel> filtersList)
        {
            ...
            var total = _EC.Count<tbCustomerShipNotesModel>(WhereCondition, null, GSEnums.WithInQuery.NoLock);
            return total;
        }

        public string Add(tbCustomerShipNotesModel model, bool AutoCommit = true, EasyCrud _EC = null)
        {
        ...
        public bool Update(Guid GUIDLocation, tbCustomerShipNotesModel model, bool AutoCommit = true, EasyCrud _EC = null)
        {
            if (!AutoCommit && _EC == null) { throw new Exception("When AutoCommit is False EasyCrud Object Needs to be passed"); }
            if (_EC == null) { _EC = new EasyCrud(ConnectionString); }
        ...
        public bool HardDelete(Guid GUIDLocation, bool AutoCommit = true, EasyCrud _EC = null)
        {
            ...
            var recs = _EC.Remove<tbCustomerShipNotesModel>(WhereCondition, "GUIDLocation", Parameters, AutoCommit);
