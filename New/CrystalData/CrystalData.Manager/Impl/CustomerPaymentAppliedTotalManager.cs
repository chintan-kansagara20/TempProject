...
{
    public class CustomerPaymentAppliedTotalManager : ICustomerPaymentAppliedTotalManager
    {
        private readonly ICustomerPaymentAppliedTotalDataAccess DataAccess = null;
        public CustomerPaymentAppliedTotalManager(ICustomerPaymentAppliedTotalDataAccess dataAccess)
        {
