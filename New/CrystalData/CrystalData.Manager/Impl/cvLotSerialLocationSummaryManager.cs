...
{
    public class cvLotSerialLocationSummaryManager : IcvLotSerialLocationSummaryManager
    {
        private readonly IcvLotSerialLocationSummaryDataAccess DataAccess = null;
        public cvLotSerialLocationSummaryManager(IcvLotSerialLocationSummaryDataAccess dataAccess)
        {
