...
{
    public class cvLinkConfigDocumentsManager : IcvLinkConfigDocumentsManager
    {
        private readonly IcvLinkConfigDocumentsDataAccess DataAccess = null;
        public cvLinkConfigDocumentsManager(IcvLinkConfigDocumentsDataAccess dataAccess)
        {
