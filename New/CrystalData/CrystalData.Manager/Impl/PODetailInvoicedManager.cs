...
{
    public class PODetailInvoicedManager : IPODetailInvoicedManager
    {
        private readonly IPODetailInvoicedDataAccess DataAccess = null;
        public PODetailInvoicedManager(IPODetailInvoicedDataAccess dataAccess)
        {
