...
{
    public class ReportDefinitionManager : IReportDefinitionManager
    {
        private readonly IReportDefinitionDataAccess DataAccess = null;
        public ReportDefinitionManager(IReportDefinitionDataAccess dataAccess)
        {
