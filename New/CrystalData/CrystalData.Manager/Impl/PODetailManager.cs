...
{
    public class PODetailManager : IPODetailManager
    {
        private readonly IPODetailDataAccess DataAccess = null;
        public PODetailManager(IPODetailDataAccess dataAccess)
        {
