...
{
    public class cvAssemblyOrdersExtendedManager : IcvAssemblyOrdersExtendedManager
    {
        private readonly IcvAssemblyOrdersExtendedDataAccess DataAccess = null;
        public cvAssemblyOrdersExtendedManager(IcvAssemblyOrdersExtendedDataAccess dataAccess)
        {
