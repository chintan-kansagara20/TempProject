...
{
    public class CustomerViewManager : ICustomerViewManager
    {
        private readonly ICustomerViewDataAccess DataAccess = null;
        public CustomerViewManager(ICustomerViewDataAccess dataAccess)
        {
