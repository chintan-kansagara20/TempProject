...
{
    public class BusinessActivityHistoryManager : IBusinessActivityHistoryManager
    {
        private readonly IBusinessActivityHistoryDataAccess DataAccess = null;
        public BusinessActivityHistoryManager(IBusinessActivityHistoryDataAccess dataAccess)
        {
