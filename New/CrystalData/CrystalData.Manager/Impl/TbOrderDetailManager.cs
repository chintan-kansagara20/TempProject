...
{
    public class TbOrderDetailManager : ITbOrderDetailManager
    {
        private readonly ITbOrderDetailDataAccess DataAccess = null;
        public TbOrderDetailManager(ITbOrderDetailDataAccess dataAccess)
        {
