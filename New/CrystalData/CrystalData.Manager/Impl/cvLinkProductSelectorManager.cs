...
{
    public class cvLinkProductSelectorManager : IcvLinkProductSelectorManager
    {
        private readonly IcvLinkProductSelectorDataAccess DataAccess = null;
        public cvLinkProductSelectorManager(IcvLinkProductSelectorDataAccess dataAccess)
        {
