...
{
    public class cvproductManager : IcvproductManager
    {
        private readonly IcvproductDataAccess DataAccess = null;
        public cvproductManager(IcvproductDataAccess dataAccess)
        {
