...
{
    public class TbAccessManager : ITbAccessManager
    {
        private readonly ITbAccessDataAccess DataAccess = null;
        public TbAccessManager(ITbAccessDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbAccessModel model)
        {
        ...
        public APIResponse Update(Guid GUIDAccess, tbAccessModel model)
        {
            var result = DataAccess.Update(GUIDAccess, model);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse HardDelete(Guid GUIDAccess)
        {
            var result = DataAccess.HardDelete(GUIDAccess);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
