...
{
    public class IssueTypeCodeXrefManager : IIssueTypeCodeXrefManager
    {
        private readonly IIssueTypeCodeXrefDataAccess DataAccess = null;
        public IssueTypeCodeXrefManager(IIssueTypeCodeXrefDataAccess dataAccess)
        {
