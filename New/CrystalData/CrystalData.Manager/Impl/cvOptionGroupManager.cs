...
{
    public class cvOptionGroupManager : IcvOptionGroupManager
    {
        private readonly IcvOptionGroupDataAccess DataAccess = null;
        public cvOptionGroupManager(IcvOptionGroupDataAccess dataAccess)
        {
