...
{
    public class TbEDICreditHeaderManager : ITbEDICreditHeaderManager
    {
        private readonly ITbEDICreditHeaderDataAccess DataAccess = null;
        public TbEDICreditHeaderManager(ITbEDICreditHeaderDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbEDICreditHeaderModel model)
        {
        ...
        public APIResponse Update(Int32 PKIDEDICreditHeader, tbEDICreditHeaderModel model)
        {
            var result = DataAccess.Update(PKIDEDICreditHeader, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(Int32 PKIDEDICreditHeader)
        {
            var result = DataAccess.HardDelete(PKIDEDICreditHeader);
            if (result)
            {
