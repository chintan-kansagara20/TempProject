...
{
    public class TbCustomerShipNotesManager : ITbCustomerShipNotesManager
    {
        private readonly ITbCustomerShipNotesDataAccess DataAccess = null;
        public TbCustomerShipNotesManager(ITbCustomerShipNotesDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbCustomerShipNotesModel model)
        {
        ...
        public APIResponse Update(Guid GUIDLocation, tbCustomerShipNotesModel model)
        {
