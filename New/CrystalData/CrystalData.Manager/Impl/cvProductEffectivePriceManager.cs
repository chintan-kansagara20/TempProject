...
{
    public class cvProductEffectivePriceManager : IcvProductEffectivePriceManager
    {
        private readonly IcvProductEffectivePriceDataAccess DataAccess = null;
        public cvProductEffectivePriceManager(IcvProductEffectivePriceDataAccess dataAccess)
        {
