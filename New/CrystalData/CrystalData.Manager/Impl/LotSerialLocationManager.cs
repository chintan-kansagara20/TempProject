...
{
    public class LotSerialLocationManager : ILotSerialLocationManager
    {
        private readonly ILotSerialLocationDataAccess DataAccess = null;
        public LotSerialLocationManager(ILotSerialLocationDataAccess dataAccess)
        {
