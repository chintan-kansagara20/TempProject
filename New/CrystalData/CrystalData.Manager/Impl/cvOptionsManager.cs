...
{
    public class cvOptionsManager : IcvOptionsManager
    {
        private readonly IcvOptionsDataAccess DataAccess = null;
        public cvOptionsManager(IcvOptionsDataAccess dataAccess)
        {
