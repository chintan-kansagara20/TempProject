...
{
    public class ImportDefaultMapManager : IImportDefaultMapManager
    {
        private readonly IImportDefaultMapDataAccess DataAccess = null;
        public ImportDefaultMapManager(IImportDefaultMapDataAccess dataAccess)
        {
