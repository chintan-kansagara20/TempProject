...
{
    public class tbChargeManager : ItbChargeManager
    {
        private readonly ItbChargeDataAccess DataAccess = null;
        public tbChargeManager(ItbChargeDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbChargeModel model)
        {
        ...
        public APIResponse Update(Guid GUIDCharge, tbChargeModel model)
        {
            var result = DataAccess.Update(GUIDCharge, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(Guid GUIDCharge)
        {
            var result = DataAccess.HardDelete(GUIDCharge);
            if (result)
            {
