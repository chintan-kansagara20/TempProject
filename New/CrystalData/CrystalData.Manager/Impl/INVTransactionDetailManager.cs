...
{
    public class INVTransactionDetailManager : IINVTransactionDetailManager
    {
        private readonly IINVTransactionDetailDataAccess DataAccess = null;
        public INVTransactionDetailManager(IINVTransactionDetailDataAccess dataAccess)
        {
