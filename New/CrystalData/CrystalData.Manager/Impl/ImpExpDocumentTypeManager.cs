...
{
    public class ImpExpDocumentTypeManager : IImpExpDocumentTypeManager
    {
        private readonly IImpExpDocumentTypeDataAccess DataAccess = null;
        public ImpExpDocumentTypeManager(IImpExpDocumentTypeDataAccess dataAccess)
        {
