...
{
    public class ShipmentOrderDetailToPackManager : IShipmentOrderDetailToPackManager
    {
        private readonly IShipmentOrderDetailToPackDataAccess DataAccess = null;
        public ShipmentOrderDetailToPackManager(IShipmentOrderDetailToPackDataAccess dataAccess)
        {
