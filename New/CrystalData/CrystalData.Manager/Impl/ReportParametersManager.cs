...
{
    public class ReportParametersManager : IReportParametersManager
    {
        private readonly IReportParametersDataAccess DataAccess = null;
        public ReportParametersManager(IReportParametersDataAccess dataAccess)
        {
