...
{
    public class PrinterAssignmentManager : IPrinterAssignmentManager
    {
        private readonly IPrinterAssignmentDataAccess DataAccess = null;
        public PrinterAssignmentManager(IPrinterAssignmentDataAccess dataAccess)
        {
