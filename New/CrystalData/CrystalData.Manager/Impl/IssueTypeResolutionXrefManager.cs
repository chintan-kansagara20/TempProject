...
{
    public class IssueTypeResolutionXrefManager : IIssueTypeResolutionXrefManager
    {
        private readonly IIssueTypeResolutionXrefDataAccess DataAccess = null;
        public IssueTypeResolutionXrefManager(IIssueTypeResolutionXrefDataAccess dataAccess)
        {
