...
{
    public class cvAssemblyUnallocatedComponentsManager : IcvAssemblyUnallocatedComponentsManager
    {
        private readonly IcvAssemblyUnallocatedComponentsDataAccess DataAccess = null;
        public cvAssemblyUnallocatedComponentsManager(IcvAssemblyUnallocatedComponentsDataAccess dataAccess)
        {
