...
{
    public class ImportTableManager : IImportTableManager
    {
        private readonly IImportTableDataAccess DataAccess = null;
        public ImportTableManager(IImportTableDataAccess dataAccess)
        {
