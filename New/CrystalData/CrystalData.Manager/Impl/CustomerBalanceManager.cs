...
{
    public class CustomerBalanceManager : ICustomerBalanceManager
    {
        private readonly ICustomerBalanceDataAccess DataAccess = null;
        public CustomerBalanceManager(ICustomerBalanceDataAccess dataAccess)
        {
