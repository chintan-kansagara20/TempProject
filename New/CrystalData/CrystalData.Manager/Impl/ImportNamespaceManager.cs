...
{
    public class ImportNamespaceManager : IImportNamespaceManager
    {
        private readonly IImportNamespaceDataAccess DataAccess = null;
        public ImportNamespaceManager(IImportNamespaceDataAccess dataAccess)
        {
