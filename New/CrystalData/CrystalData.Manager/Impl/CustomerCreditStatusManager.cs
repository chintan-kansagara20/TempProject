...
{
    public class CustomerCreditStatusManager : ICustomerCreditStatusManager
    {
        private readonly ICustomerCreditStatusDataAccess DataAccess = null;
        public CustomerCreditStatusManager(ICustomerCreditStatusDataAccess dataAccess)
        {
