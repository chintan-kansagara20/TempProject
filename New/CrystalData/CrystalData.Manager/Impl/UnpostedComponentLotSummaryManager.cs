...
{
    public class UnpostedComponentLotSummaryManager : IUnpostedComponentLotSummaryManager
    {
        private readonly IUnpostedComponentLotSummaryDataAccess DataAccess = null;
        public UnpostedComponentLotSummaryManager(IUnpostedComponentLotSummaryDataAccess dataAccess)
        {
