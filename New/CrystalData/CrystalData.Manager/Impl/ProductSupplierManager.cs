...
{
    public class ProductSupplierManager : IProductSupplierManager
    {
        private readonly IProductSupplierDataAccess DataAccess = null;
        public ProductSupplierManager(IProductSupplierDataAccess dataAccess)
        {
