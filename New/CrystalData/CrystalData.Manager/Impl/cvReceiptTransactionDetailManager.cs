...
{
    public class cvReceiptTransactionDetailManager : IcvReceiptTransactionDetailManager
    {
        private readonly IcvReceiptTransactionDetailDataAccess DataAccess = null;
        public cvReceiptTransactionDetailManager(IcvReceiptTransactionDetailDataAccess dataAccess)
        {
