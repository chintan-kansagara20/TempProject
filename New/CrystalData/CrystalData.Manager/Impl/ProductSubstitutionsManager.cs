...
{
    public class ProductSubstitutionsManager : IProductSubstitutionsManager
    {
        private readonly IProductSubstitutionsDataAccess DataAccess = null;
        public ProductSubstitutionsManager(IProductSubstitutionsDataAccess dataAccess)
        {
