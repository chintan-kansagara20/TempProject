...
{
    public class PicklistDetailLotManager : IPicklistDetailLotManager
    {
        private readonly IPicklistDetailLotDataAccess DataAccess = null;
        public PicklistDetailLotManager(IPicklistDetailLotDataAccess dataAccess)
        {
