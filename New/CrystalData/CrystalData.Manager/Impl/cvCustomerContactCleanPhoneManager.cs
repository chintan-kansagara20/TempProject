...
{
    public class cvCustomerContactCleanPhoneManager : IcvCustomerContactCleanPhoneManager
    {
        private readonly IcvCustomerContactCleanPhoneDataAccess DataAccess = null;
        public cvCustomerContactCleanPhoneManager(IcvCustomerContactCleanPhoneDataAccess dataAccess)
        {
