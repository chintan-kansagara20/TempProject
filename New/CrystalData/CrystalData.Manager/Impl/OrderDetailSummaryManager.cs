...
{
    public class OrderDetailSummaryManager : IOrderDetailSummaryManager
    {
        private readonly IOrderDetailSummaryDataAccess DataAccess = null;
        public OrderDetailSummaryManager(IOrderDetailSummaryDataAccess dataAccess)
        {
