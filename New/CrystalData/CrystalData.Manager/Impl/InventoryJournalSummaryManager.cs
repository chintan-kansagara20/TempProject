...
{
    public class InventoryJournalSummaryManager : IInventoryJournalSummaryManager
    {
        private readonly IInventoryJournalSummaryDataAccess DataAccess = null;
        public InventoryJournalSummaryManager(IInventoryJournalSummaryDataAccess dataAccess)
        {
