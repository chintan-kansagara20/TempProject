...
{
    public class YearWeekManager : IYearWeekManager
    {
        private readonly IYearWeekDataAccess DataAccess = null;
        public YearWeekManager(IYearWeekDataAccess dataAccess)
        {
