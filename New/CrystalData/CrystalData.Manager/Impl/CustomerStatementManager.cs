...
{
    public class CustomerStatementManager : ICustomerStatementManager
    {
        private readonly ICustomerStatementDataAccess DataAccess = null;
        public CustomerStatementManager(ICustomerStatementDataAccess dataAccess)
        {
