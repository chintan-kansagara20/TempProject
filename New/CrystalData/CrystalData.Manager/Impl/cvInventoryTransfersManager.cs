...
{
    public class cvInventoryTransfersManager : IcvInventoryTransfersManager
    {
        private readonly IcvInventoryTransfersDataAccess DataAccess = null;
        public cvInventoryTransfersManager(IcvInventoryTransfersDataAccess dataAccess)
        {
