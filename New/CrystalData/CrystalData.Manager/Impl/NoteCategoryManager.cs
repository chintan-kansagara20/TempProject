...
{
    public class NoteCategoryManager : INoteCategoryManager
    {
        private readonly INoteCategoryDataAccess DataAccess = null;
        public NoteCategoryManager(INoteCategoryDataAccess dataAccess)
        {
