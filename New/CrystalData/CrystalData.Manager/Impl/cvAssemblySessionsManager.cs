...
{
    public class cvAssemblySessionsManager : IcvAssemblySessionsManager
    {
        private readonly IcvAssemblySessionsDataAccess DataAccess = null;
        public cvAssemblySessionsManager(IcvAssemblySessionsDataAccess dataAccess)
        {
