...
{
    public class LotSerialLocationSummaryNoAvailabilityManager : ILotSerialLocationSummaryNoAvailabilityManager
    {
        private readonly ILotSerialLocationSummaryNoAvailabilityDataAccess DataAccess = null;
        public LotSerialLocationSummaryNoAvailabilityManager(ILotSerialLocationSummaryNoAvailabilityDataAccess dataAccess)
        {
