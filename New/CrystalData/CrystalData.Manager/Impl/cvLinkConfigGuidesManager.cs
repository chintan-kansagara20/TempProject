...
{
    public class cvLinkConfigGuidesManager : IcvLinkConfigGuidesManager
    {
        private readonly IcvLinkConfigGuidesDataAccess DataAccess = null;
        public cvLinkConfigGuidesManager(IcvLinkConfigGuidesDataAccess dataAccess)
        {
