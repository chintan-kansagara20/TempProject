...
{
    public class TbProductComponentManager : ITbProductComponentManager
    {
        private readonly ITbProductComponentDataAccess DataAccess = null;
        public TbProductComponentManager(ITbProductComponentDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbProductComponentModel model)
        {
        ...
        public APIResponse Update(Guid GUIDProductComponent, tbProductComponentModel model)
        {
            var result = DataAccess.Update(GUIDProductComponent, model);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse HardDelete(Guid GUIDProductComponent)
        {
            var result = DataAccess.HardDelete(GUIDProductComponent);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
