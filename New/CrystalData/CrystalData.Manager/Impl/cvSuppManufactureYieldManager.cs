...
{
    public class cvSuppManufactureYieldManager : IcvSuppManufactureYieldManager
    {
        private readonly IcvSuppManufactureYieldDataAccess DataAccess = null;
        public cvSuppManufactureYieldManager(IcvSuppManufactureYieldDataAccess dataAccess)
        {
