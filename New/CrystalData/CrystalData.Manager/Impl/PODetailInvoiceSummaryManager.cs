...
{
    public class PODetailInvoiceSummaryManager : IPODetailInvoiceSummaryManager
    {
        private readonly IPODetailInvoiceSummaryDataAccess DataAccess = null;
        public PODetailInvoiceSummaryManager(IPODetailInvoiceSummaryDataAccess dataAccess)
        {
