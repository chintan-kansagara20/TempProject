...
{
    public class cvAssemblyComponentAvailabilityManager : IcvAssemblyComponentAvailabilityManager
    {
        private readonly IcvAssemblyComponentAvailabilityDataAccess DataAccess = null;
        public cvAssemblyComponentAvailabilityManager(IcvAssemblyComponentAvailabilityDataAccess dataAccess)
        {
