...
{
    public class ImpExpDocumentColumnManager : IImpExpDocumentColumnManager
    {
        private readonly IImpExpDocumentColumnDataAccess DataAccess = null;
        public ImpExpDocumentColumnManager(IImpExpDocumentColumnDataAccess dataAccess)
        {
