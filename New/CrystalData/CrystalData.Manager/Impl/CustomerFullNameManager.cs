...
{
    public class CustomerFullNameManager : ICustomerFullNameManager
    {
        private readonly ICustomerFullNameDataAccess DataAccess = null;
        public CustomerFullNameManager(ICustomerFullNameDataAccess dataAccess)
        {
