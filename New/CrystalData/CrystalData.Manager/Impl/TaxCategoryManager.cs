...
{
    public class TaxCategoryManager : ITaxCategoryManager
    {
        private readonly ITaxCategoryDataAccess DataAccess = null;
        public TaxCategoryManager(ITaxCategoryDataAccess dataAccess)
        {
