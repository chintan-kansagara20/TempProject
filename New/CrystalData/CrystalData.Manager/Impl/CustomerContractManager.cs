...
{
    public class CustomerContractManager : ICustomerContractManager
    {
        private readonly ICustomerContractDataAccess DataAccess = null;
        public CustomerContractManager(ICustomerContractDataAccess dataAccess)
        {
