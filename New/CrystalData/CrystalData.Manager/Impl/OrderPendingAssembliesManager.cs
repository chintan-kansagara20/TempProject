...
{
    public class OrderPendingAssembliesManager : IOrderPendingAssembliesManager
    {
        private readonly IOrderPendingAssembliesDataAccess DataAccess = null;
        public OrderPendingAssembliesManager(IOrderPendingAssembliesDataAccess dataAccess)
        {
