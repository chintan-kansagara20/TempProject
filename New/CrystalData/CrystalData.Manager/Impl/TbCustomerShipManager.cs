...
{
    public class TbCustomerShipManager : ITbCustomerShipManager
    {
        private readonly ITbCustomerShipDataAccess DataAccess = null;
        public TbCustomerShipManager(ITbCustomerShipDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbCustomerShipModel model)
        {
        ...
        public APIResponse Update(Guid GUIDLocation, tbCustomerShipModel model)
        {
