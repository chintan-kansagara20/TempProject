...
{
    public class cvLinkConfigDocumentFoldersManager : IcvLinkConfigDocumentFoldersManager
    {
        private readonly IcvLinkConfigDocumentFoldersDataAccess DataAccess = null;
        public cvLinkConfigDocumentFoldersManager(IcvLinkConfigDocumentFoldersDataAccess dataAccess)
        {
