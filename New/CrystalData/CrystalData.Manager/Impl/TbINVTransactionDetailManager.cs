...
{
    public class TbINVTransactionDetailManager : ITbINVTransactionDetailManager
    {
        private readonly ITbINVTransactionDetailDataAccess DataAccess = null;
        public TbINVTransactionDetailManager(ITbINVTransactionDetailDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbINVTransactionDetailModel model)
        {
        ...
        public APIResponse Update(Guid GUIDINVTransactionDetail, tbINVTransactionDetailModel model)
        {
            var result = DataAccess.Update(GUIDINVTransactionDetail, model);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse HardDelete(Guid GUIDINVTransactionDetail)
        {
            var result = DataAccess.HardDelete(GUIDINVTransactionDetail);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
