...
{
    public class cvProductExportNSSManager : IcvProductExportNSSManager
    {
        private readonly IcvProductExportNSSDataAccess DataAccess = null;
        public cvProductExportNSSManager(IcvProductExportNSSDataAccess dataAccess)
        {
