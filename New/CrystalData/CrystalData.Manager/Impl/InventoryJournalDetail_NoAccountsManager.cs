...
{
    public class InventoryJournalDetail_NoAccountsManager : IInventoryJournalDetail_NoAccountsManager
    {
        private readonly IInventoryJournalDetail_NoAccountsDataAccess DataAccess = null;
        public InventoryJournalDetail_NoAccountsManager(IInventoryJournalDetail_NoAccountsDataAccess dataAccess)
        {
