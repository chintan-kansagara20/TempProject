...
{
    public class PicklistOrderManager : IPicklistOrderManager
    {
        private readonly IPicklistOrderDataAccess DataAccess = null;
        public PicklistOrderManager(IPicklistOrderDataAccess dataAccess)
        {
