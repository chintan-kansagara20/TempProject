...
{
    public class cvProductAvailabilityManager : IcvProductAvailabilityManager
    {
        private readonly IcvProductAvailabilityDataAccess DataAccess = null;
        public cvProductAvailabilityManager(IcvProductAvailabilityDataAccess dataAccess)
        {
