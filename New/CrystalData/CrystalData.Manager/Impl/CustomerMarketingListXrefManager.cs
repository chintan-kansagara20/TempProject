...
{
    public class CustomerMarketingListXrefManager : ICustomerMarketingListXrefManager
    {
        private readonly ICustomerMarketingListXrefDataAccess DataAccess = null;
        public CustomerMarketingListXrefManager(ICustomerMarketingListXrefDataAccess dataAccess)
        {
