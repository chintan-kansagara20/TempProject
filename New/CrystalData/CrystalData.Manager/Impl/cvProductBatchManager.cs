...
{
    public class cvProductBatchManager : IcvProductBatchManager
    {
        private readonly IcvProductBatchDataAccess DataAccess = null;
        public cvProductBatchManager(IcvProductBatchDataAccess dataAccess)
        {
