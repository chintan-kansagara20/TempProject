...
{
    public class InvoiceAmtSummaryManager : IInvoiceAmtSummaryManager
    {
        private readonly IInvoiceAmtSummaryDataAccess DataAccess = null;
        public InvoiceAmtSummaryManager(IInvoiceAmtSummaryDataAccess dataAccess)
        {
