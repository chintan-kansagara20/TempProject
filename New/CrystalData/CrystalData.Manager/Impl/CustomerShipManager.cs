...
{
    public class CustomerShipManager : ICustomerShipManager
    {
        private readonly ICustomerShipDataAccess DataAccess = null;
        public CustomerShipManager(ICustomerShipDataAccess dataAccess)
        {
