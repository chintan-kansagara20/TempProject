...
{
    public class BusinessActivityManager : IBusinessActivityManager
    {
        private readonly IBusinessActivityDataAccess DataAccess = null;
        public BusinessActivityManager(IBusinessActivityDataAccess dataAccess)
        {
