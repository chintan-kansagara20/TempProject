...
{
    public class LotSerialInventoryIssuesManager : ILotSerialInventoryIssuesManager
    {
        private readonly ILotSerialInventoryIssuesDataAccess DataAccess = null;
        public LotSerialInventoryIssuesManager(ILotSerialInventoryIssuesDataAccess dataAccess)
        {
