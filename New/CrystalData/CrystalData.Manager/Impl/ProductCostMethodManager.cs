...
{
    public class ProductCostMethodManager : IProductCostMethodManager
    {
        private readonly IProductCostMethodDataAccess DataAccess = null;
        public ProductCostMethodManager(IProductCostMethodDataAccess dataAccess)
        {
