...
{
    public class CostLayersManager : ICostLayersManager
    {
        private readonly ICostLayersDataAccess DataAccess = null;
        public CostLayersManager(ICostLayersDataAccess dataAccess)
        {
