...
{
    public class UnpostedTransferLotLocationSummaryManager : IUnpostedTransferLotLocationSummaryManager
    {
        private readonly IUnpostedTransferLotLocationSummaryDataAccess DataAccess = null;
        public UnpostedTransferLotLocationSummaryManager(IUnpostedTransferLotLocationSummaryDataAccess dataAccess)
        {
