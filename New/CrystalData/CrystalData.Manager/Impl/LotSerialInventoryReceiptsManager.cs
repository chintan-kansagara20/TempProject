...
{
    public class LotSerialInventoryReceiptsManager : ILotSerialInventoryReceiptsManager
    {
        private readonly ILotSerialInventoryReceiptsDataAccess DataAccess = null;
        public LotSerialInventoryReceiptsManager(ILotSerialInventoryReceiptsDataAccess dataAccess)
        {
