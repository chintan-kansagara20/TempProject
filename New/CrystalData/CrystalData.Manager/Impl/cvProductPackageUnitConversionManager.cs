...
{
    public class cvProductPackageUnitConversionManager : IcvProductPackageUnitConversionManager
    {
        private readonly IcvProductPackageUnitConversionDataAccess DataAccess = null;
        public cvProductPackageUnitConversionManager(IcvProductPackageUnitConversionDataAccess dataAccess)
        {
