...
{
    public class ProductControlTypeManager : IProductControlTypeManager
    {
        private readonly IProductControlTypeDataAccess DataAccess = null;
        public ProductControlTypeManager(IProductControlTypeDataAccess dataAccess)
        {
