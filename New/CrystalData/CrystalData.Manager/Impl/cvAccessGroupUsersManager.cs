...
{
    public class cvAccessGroupUsersManager : IcvAccessGroupUsersManager
    {
        private readonly IcvAccessGroupUsersDataAccess DataAccess = null;
        public cvAccessGroupUsersManager(IcvAccessGroupUsersDataAccess dataAccess)
        {
