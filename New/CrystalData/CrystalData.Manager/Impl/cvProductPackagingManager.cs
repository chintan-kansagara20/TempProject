...
{
    public class cvProductPackagingManager : IcvProductPackagingManager
    {
        private readonly IcvProductPackagingDataAccess DataAccess = null;
        public cvProductPackagingManager(IcvProductPackagingDataAccess dataAccess)
        {
