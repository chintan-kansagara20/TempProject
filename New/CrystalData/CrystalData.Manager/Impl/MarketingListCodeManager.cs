...
{
    public class MarketingListCodeManager : IMarketingListCodeManager
    {
        private readonly IMarketingListCodeDataAccess DataAccess = null;
        public MarketingListCodeManager(IMarketingListCodeDataAccess dataAccess)
        {
