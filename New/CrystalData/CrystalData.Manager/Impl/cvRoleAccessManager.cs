...
{
    public class cvRoleAccessManager : IcvRoleAccessManager
    {
        private readonly IcvRoleAccessDataAccess DataAccess = null;
        public cvRoleAccessManager(IcvRoleAccessDataAccess dataAccess)
        {
