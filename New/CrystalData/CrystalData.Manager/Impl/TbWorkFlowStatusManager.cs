...
{
    public class TbWorkFlowStatusManager : ITbWorkFlowStatusManager
    {
        private readonly ITbWorkFlowStatusDataAccess DataAccess = null;
        public TbWorkFlowStatusManager(ITbWorkFlowStatusDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbWorkFlowStatusModel model)
        {
