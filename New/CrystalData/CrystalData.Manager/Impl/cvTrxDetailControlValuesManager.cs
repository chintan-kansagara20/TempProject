...
{
    public class cvTrxDetailControlValuesManager : IcvTrxDetailControlValuesManager
    {
        private readonly IcvTrxDetailControlValuesDataAccess DataAccess = null;
        public cvTrxDetailControlValuesManager(IcvTrxDetailControlValuesDataAccess dataAccess)
        {
