...
{
    public class LocationSummaryNoAvailabilityManager : ILocationSummaryNoAvailabilityManager
    {
        private readonly ILocationSummaryNoAvailabilityDataAccess DataAccess = null;
        public LocationSummaryNoAvailabilityManager(ILocationSummaryNoAvailabilityDataAccess dataAccess)
        {
