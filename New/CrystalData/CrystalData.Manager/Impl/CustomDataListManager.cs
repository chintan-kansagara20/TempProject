...
{
    public class CustomDataListManager : ICustomDataListManager
    {
        private readonly ICustomDataListDataAccess DataAccess = null;
        public CustomDataListManager(ICustomDataListDataAccess dataAccess)
        {
