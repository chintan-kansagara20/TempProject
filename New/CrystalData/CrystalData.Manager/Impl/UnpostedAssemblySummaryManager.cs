...
{
    public class UnpostedAssemblySummaryManager : IUnpostedAssemblySummaryManager
    {
        private readonly IUnpostedAssemblySummaryDataAccess DataAccess = null;
        public UnpostedAssemblySummaryManager(IUnpostedAssemblySummaryDataAccess dataAccess)
        {
