...
{
    public class CostLayerIssuesManager : ICostLayerIssuesManager
    {
        private readonly ICostLayerIssuesDataAccess DataAccess = null;
        public CostLayerIssuesManager(ICostLayerIssuesDataAccess dataAccess)
        {
