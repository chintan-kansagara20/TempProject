...
{
    public class CustomerPaymentInvoiceTotalManager : ICustomerPaymentInvoiceTotalManager
    {
        private readonly ICustomerPaymentInvoiceTotalDataAccess DataAccess = null;
        public CustomerPaymentInvoiceTotalManager(ICustomerPaymentInvoiceTotalDataAccess dataAccess)
        {
