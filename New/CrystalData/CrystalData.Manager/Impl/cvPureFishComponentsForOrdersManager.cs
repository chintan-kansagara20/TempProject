...
{
    public class cvPureFishComponentsForOrdersManager : IcvPureFishComponentsForOrdersManager
    {
        private readonly IcvPureFishComponentsForOrdersDataAccess DataAccess = null;
        public cvPureFishComponentsForOrdersManager(IcvPureFishComponentsForOrdersDataAccess dataAccess)
        {
