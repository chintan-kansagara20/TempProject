...
{
    public class OrderDetailLotManager : IOrderDetailLotManager
    {
        private readonly IOrderDetailLotDataAccess DataAccess = null;
        public OrderDetailLotManager(IOrderDetailLotDataAccess dataAccess)
        {
