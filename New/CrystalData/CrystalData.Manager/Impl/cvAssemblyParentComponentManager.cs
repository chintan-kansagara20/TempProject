...
{
    public class cvAssemblyParentComponentManager : IcvAssemblyParentComponentManager
    {
        private readonly IcvAssemblyParentComponentDataAccess DataAccess = null;
        public cvAssemblyParentComponentManager(IcvAssemblyParentComponentDataAccess dataAccess)
        {
