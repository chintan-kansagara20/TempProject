...
{
    public class POManagementSummaryManager : IPOManagementSummaryManager
    {
        private readonly IPOManagementSummaryDataAccess DataAccess = null;
        public POManagementSummaryManager(IPOManagementSummaryDataAccess dataAccess)
        {
