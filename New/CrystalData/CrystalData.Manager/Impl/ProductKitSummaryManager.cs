...
{
    public class ProductKitSummaryManager : IProductKitSummaryManager
    {
        private readonly IProductKitSummaryDataAccess DataAccess = null;
        public ProductKitSummaryManager(IProductKitSummaryDataAccess dataAccess)
        {
