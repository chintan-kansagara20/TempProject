...
{
    public class OrderManagementSummaryManager : IOrderManagementSummaryManager
    {
        private readonly IOrderManagementSummaryDataAccess DataAccess = null;
        public OrderManagementSummaryManager(IOrderManagementSummaryDataAccess dataAccess)
        {
