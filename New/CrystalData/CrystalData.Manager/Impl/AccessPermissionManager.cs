...
{
    public class AccessPermissionManager : IAccessPermissionManager
    {
        private readonly IAccessPermissionDataAccess DataAccess = null;
        public AccessPermissionManager(IAccessPermissionDataAccess dataAccess)
        {
