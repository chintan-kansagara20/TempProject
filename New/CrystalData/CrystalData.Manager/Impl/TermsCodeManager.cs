...
{
    public class TermsCodeManager : ITermsCodeManager
    {
        private readonly ITermsCodeDataAccess DataAccess = null;
        public TermsCodeManager(ITermsCodeDataAccess dataAccess)
        {
