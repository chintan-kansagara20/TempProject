...
{
    public class PicklistDetailManager : IPicklistDetailManager
    {
        private readonly IPicklistDetailDataAccess DataAccess = null;
        public PicklistDetailManager(IPicklistDetailDataAccess dataAccess)
        {
