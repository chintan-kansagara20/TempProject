...
{
    public class CustomerShipToInfoManager : ICustomerShipToInfoManager
    {
        private readonly ICustomerShipToInfoDataAccess DataAccess = null;
        public CustomerShipToInfoManager(ICustomerShipToInfoDataAccess dataAccess)
        {
