...
{
    public class LotSerialLocationSummaryManager : ILotSerialLocationSummaryManager
    {
        private readonly ILotSerialLocationSummaryDataAccess DataAccess = null;
        public LotSerialLocationSummaryManager(ILotSerialLocationSummaryDataAccess dataAccess)
        {
