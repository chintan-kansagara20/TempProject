...
{
    public class ShipmentPicklistDetailManager : IShipmentPicklistDetailManager
    {
        private readonly IShipmentPicklistDetailDataAccess DataAccess = null;
        public ShipmentPicklistDetailManager(IShipmentPicklistDetailDataAccess dataAccess)
        {
