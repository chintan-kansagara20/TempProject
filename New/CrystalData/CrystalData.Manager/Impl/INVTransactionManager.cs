...
{
    public class INVTransactionManager : IINVTransactionManager
    {
        private readonly IINVTransactionDataAccess DataAccess = null;
        public INVTransactionManager(IINVTransactionDataAccess dataAccess)
        {
