...
{
    public class OrderDetailTopLevelComponentQuantityManager : IOrderDetailTopLevelComponentQuantityManager
    {
        private readonly IOrderDetailTopLevelComponentQuantityDataAccess DataAccess = null;
        public OrderDetailTopLevelComponentQuantityManager(IOrderDetailTopLevelComponentQuantityDataAccess dataAccess)
        {
