...
{
    public class cvIssueAssemblyManager : IcvIssueAssemblyManager
    {
        private readonly IcvIssueAssemblyDataAccess DataAccess = null;
        public cvIssueAssemblyManager(IcvIssueAssemblyDataAccess dataAccess)
        {
