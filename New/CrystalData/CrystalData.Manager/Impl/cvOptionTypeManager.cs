...
{
    public class cvOptionTypeManager : IcvOptionTypeManager
    {
        private readonly IcvOptionTypeDataAccess DataAccess = null;
        public cvOptionTypeManager(IcvOptionTypeDataAccess dataAccess)
        {
