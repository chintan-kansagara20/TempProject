...
{
    public class TbClassManager : ITbClassManager
    {
        private readonly ITbClassDataAccess DataAccess = null;
        public TbClassManager(ITbClassDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbClassModel model)
        {
        ...
        public APIResponse Update(Guid GUIDClass, tbClassModel model)
        {
            var result = DataAccess.Update(GUIDClass, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(Guid GUIDClass)
        {
            var result = DataAccess.HardDelete(GUIDClass);
            if (result)
            {
