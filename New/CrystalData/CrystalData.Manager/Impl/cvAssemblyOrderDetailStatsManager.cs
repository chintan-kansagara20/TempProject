...
{
    public class cvAssemblyOrderDetailStatsManager : IcvAssemblyOrderDetailStatsManager
    {
        private readonly IcvAssemblyOrderDetailStatsDataAccess DataAccess = null;
        public cvAssemblyOrderDetailStatsManager(IcvAssemblyOrderDetailStatsDataAccess dataAccess)
        {
