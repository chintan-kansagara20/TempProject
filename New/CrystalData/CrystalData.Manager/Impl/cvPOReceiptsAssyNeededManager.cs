...
{
    public class cvPOReceiptsAssyNeededManager : IcvPOReceiptsAssyNeededManager
    {
        private readonly IcvPOReceiptsAssyNeededDataAccess DataAccess = null;
        public cvPOReceiptsAssyNeededManager(IcvPOReceiptsAssyNeededDataAccess dataAccess)
        {
