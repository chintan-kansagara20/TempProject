...
{
    public class MarketingListXrefManager : IMarketingListXrefManager
    {
        private readonly IMarketingListXrefDataAccess DataAccess = null;
        public MarketingListXrefManager(IMarketingListXrefDataAccess dataAccess)
        {
