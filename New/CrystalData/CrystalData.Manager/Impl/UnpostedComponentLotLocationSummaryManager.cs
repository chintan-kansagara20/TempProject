...
{
    public class UnpostedComponentLotLocationSummaryManager : IUnpostedComponentLotLocationSummaryManager
    {
        private readonly IUnpostedComponentLotLocationSummaryDataAccess DataAccess = null;
        public UnpostedComponentLotLocationSummaryManager(IUnpostedComponentLotLocationSummaryDataAccess dataAccess)
        {
