...
{
    public class POInvoiceManager : IPOInvoiceManager
    {
        private readonly IPOInvoiceDataAccess DataAccess = null;
        public POInvoiceManager(IPOInvoiceDataAccess dataAccess)
        {
