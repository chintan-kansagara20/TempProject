...
{
    public class UnpostedComponentSummaryManager : IUnpostedComponentSummaryManager
    {
        private readonly IUnpostedComponentSummaryDataAccess DataAccess = null;
        public UnpostedComponentSummaryManager(IUnpostedComponentSummaryDataAccess dataAccess)
        {
