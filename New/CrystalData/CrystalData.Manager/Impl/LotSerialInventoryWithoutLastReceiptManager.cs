...
{
    public class LotSerialInventoryWithoutLastReceiptManager : ILotSerialInventoryWithoutLastReceiptManager
    {
        private readonly ILotSerialInventoryWithoutLastReceiptDataAccess DataAccess = null;
        public LotSerialInventoryWithoutLastReceiptManager(ILotSerialInventoryWithoutLastReceiptDataAccess dataAccess)
        {
