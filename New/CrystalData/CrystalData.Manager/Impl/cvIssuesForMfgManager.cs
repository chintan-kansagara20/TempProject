...
{
    public class cvIssuesForMfgManager : IcvIssuesForMfgManager
    {
        private readonly IcvIssuesForMfgDataAccess DataAccess = null;
        public cvIssuesForMfgManager(IcvIssuesForMfgDataAccess dataAccess)
        {
