...
{
    public class cvPriorPOForProductManager : IcvPriorPOForProductManager
    {
        private readonly IcvPriorPOForProductDataAccess DataAccess = null;
        public cvPriorPOForProductManager(IcvPriorPOForProductDataAccess dataAccess)
        {
