...
{
    public class ProductWarehouseLastVoidedDateManager : IProductWarehouseLastVoidedDateManager
    {
        private readonly IProductWarehouseLastVoidedDateDataAccess DataAccess = null;
        public ProductWarehouseLastVoidedDateManager(IProductWarehouseLastVoidedDateDataAccess dataAccess)
        {
