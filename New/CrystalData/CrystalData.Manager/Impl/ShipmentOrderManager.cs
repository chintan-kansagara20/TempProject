...
{
    public class ShipmentOrderManager : IShipmentOrderManager
    {
        private readonly IShipmentOrderDataAccess DataAccess = null;
        public ShipmentOrderManager(IShipmentOrderDataAccess dataAccess)
        {
