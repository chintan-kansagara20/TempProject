...
{
    public class ProductTransactionsManager : IProductTransactionsManager
    {
        private readonly IProductTransactionsDataAccess DataAccess = null;
        public ProductTransactionsManager(IProductTransactionsDataAccess dataAccess)
        {
