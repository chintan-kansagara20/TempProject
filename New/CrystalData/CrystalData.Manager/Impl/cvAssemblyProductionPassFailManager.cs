...
{
    public class cvAssemblyProductionPassFailManager : IcvAssemblyProductionPassFailManager
    {
        private readonly IcvAssemblyProductionPassFailDataAccess DataAccess = null;
        public cvAssemblyProductionPassFailManager(IcvAssemblyProductionPassFailDataAccess dataAccess)
        {
