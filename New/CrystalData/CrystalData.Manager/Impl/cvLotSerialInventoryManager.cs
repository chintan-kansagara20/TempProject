...
{
    public class cvLotSerialInventoryManager : IcvLotSerialInventoryManager
    {
        private readonly IcvLotSerialInventoryDataAccess DataAccess = null;
        public cvLotSerialInventoryManager(IcvLotSerialInventoryDataAccess dataAccess)
        {
