...
{
    public class ProductAltIDManager : IProductAltIDManager
    {
        private readonly IProductAltIDDataAccess DataAccess = null;
        public ProductAltIDManager(IProductAltIDDataAccess dataAccess)
        {
