...
{
    public class cvProductVendorPriceManager : IcvProductVendorPriceManager
    {
        private readonly IcvProductVendorPriceDataAccess DataAccess = null;
        public cvProductVendorPriceManager(IcvProductVendorPriceDataAccess dataAccess)
        {
