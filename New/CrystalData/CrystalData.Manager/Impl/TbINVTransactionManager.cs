...
{
    public class TbINVTransactionManager : ITbINVTransactionManager
    {
        private readonly ITbINVTransactionDataAccess DataAccess = null;
        public TbINVTransactionManager(ITbINVTransactionDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbINVTransactionModel model)
        {
        ...
        public APIResponse Update(Guid GUIDINVTransaction, tbINVTransactionModel model)
        {
            var result = DataAccess.Update(GUIDINVTransaction, model);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
        ...
        public APIResponse HardDelete(Guid GUIDINVTransaction)
        {
            var result = DataAccess.HardDelete(GUIDINVTransaction);
            if (result)
            {
                return new APIResponse(ResponseCode.SUCCESS, "Record Inserted", result);
            }
