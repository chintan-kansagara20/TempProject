...
{
    public class ProductCustomerManager : IProductCustomerManager
    {
        private readonly IProductCustomerDataAccess DataAccess = null;
        public ProductCustomerManager(IProductCustomerDataAccess dataAccess)
        {
