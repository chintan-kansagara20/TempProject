...
{
    public class ProductWarehouseManager : IProductWarehouseManager
    {
        private readonly IProductWarehouseDataAccess DataAccess = null;
        public ProductWarehouseManager(IProductWarehouseDataAccess dataAccess)
        {
