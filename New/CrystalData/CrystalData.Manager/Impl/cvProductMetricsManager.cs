...
{
    public class cvProductMetricsManager : IcvProductMetricsManager
    {
        private readonly IcvProductMetricsDataAccess DataAccess = null;
        public cvProductMetricsManager(IcvProductMetricsDataAccess dataAccess)
        {
