...
{
    public class ProductDocumentHistoryManager : IProductDocumentHistoryManager
    {
        private readonly IProductDocumentHistoryDataAccess DataAccess = null;
        public ProductDocumentHistoryManager(IProductDocumentHistoryDataAccess dataAccess)
        {
