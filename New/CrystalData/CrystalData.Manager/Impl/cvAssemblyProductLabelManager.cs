...
{
    public class cvAssemblyProductLabelManager : IcvAssemblyProductLabelManager
    {
        private readonly IcvAssemblyProductLabelDataAccess DataAccess = null;
        public cvAssemblyProductLabelManager(IcvAssemblyProductLabelDataAccess dataAccess)
        {
