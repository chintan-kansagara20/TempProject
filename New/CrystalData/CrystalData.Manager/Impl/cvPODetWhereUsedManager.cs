...
{
    public class cvPODetWhereUsedManager : IcvPODetWhereUsedManager
    {
        private readonly IcvPODetWhereUsedDataAccess DataAccess = null;
        public cvPODetWhereUsedManager(IcvPODetWhereUsedDataAccess dataAccess)
        {
