...
{
    public class cvAssemblyOrderHeaderManager : IcvAssemblyOrderHeaderManager
    {
        private readonly IcvAssemblyOrderHeaderDataAccess DataAccess = null;
        public cvAssemblyOrderHeaderManager(IcvAssemblyOrderHeaderDataAccess dataAccess)
        {
