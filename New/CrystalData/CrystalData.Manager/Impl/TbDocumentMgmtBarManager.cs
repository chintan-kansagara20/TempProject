...
{
    public class TbDocumentMgmtBarManager : ITbDocumentMgmtBarManager
    {
        private readonly ITbDocumentMgmtBarDataAccess DataAccess = null;
        public TbDocumentMgmtBarManager(ITbDocumentMgmtBarDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbDocumentMgmtBarModel model)
        {
        ...
        public APIResponse Update(Guid GUIDDocumentMgmtBar, tbDocumentMgmtBarModel model)
        {
            var result = DataAccess.Update(GUIDDocumentMgmtBar, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(Guid GUIDDocumentMgmtBar)
        {
            var result = DataAccess.HardDelete(GUIDDocumentMgmtBar);
            if (result)
            {
