...
{
    public class TbEDIImportStatusManager : ITbEDIImportStatusManager
    {
        private readonly ITbEDIImportStatusDataAccess DataAccess = null;
        public TbEDIImportStatusManager(ITbEDIImportStatusDataAccess dataAccess)
        {
        ...
        public APIResponse Insert(tbEDIImportStatusModel model)
        {
        ...
        public APIResponse Update(Int32 PKIDEDIImportStatus, tbEDIImportStatusModel model)
        {
            var result = DataAccess.Update(PKIDEDIImportStatus, model);
            if (result)
            {
        ...
        public APIResponse HardDelete(Int32 PKIDEDIImportStatus)
        {
            var result = DataAccess.HardDelete(PKIDEDIImportStatus);
            if (result)
            {
