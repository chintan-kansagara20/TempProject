...
{
    public class INVLotSerialTraceDetailManager : IINVLotSerialTraceDetailManager
    {
        private readonly IINVLotSerialTraceDetailDataAccess DataAccess = null;
        public INVLotSerialTraceDetailManager(IINVLotSerialTraceDetailDataAccess dataAccess)
        {
