...
{
    public class cvAssemblyProductionReportInnerManager : IcvAssemblyProductionReportInnerManager
    {
        private readonly IcvAssemblyProductionReportInnerDataAccess DataAccess = null;
        public cvAssemblyProductionReportInnerManager(IcvAssemblyProductionReportInnerDataAccess dataAccess)
        {
