...
{
    public class ImpExpDocumentTableManager : IImpExpDocumentTableManager
    {
        private readonly IImpExpDocumentTableDataAccess DataAccess = null;
        public ImpExpDocumentTableManager(IImpExpDocumentTableDataAccess dataAccess)
        {
