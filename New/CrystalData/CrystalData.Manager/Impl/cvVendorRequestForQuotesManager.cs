...
{
    public class cvVendorRequestForQuotesManager : IcvVendorRequestForQuotesManager
    {
        private readonly IcvVendorRequestForQuotesDataAccess DataAccess = null;
        public cvVendorRequestForQuotesManager(IcvVendorRequestForQuotesDataAccess dataAccess)
        {
