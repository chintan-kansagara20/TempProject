...
{
    public class IssueSchedulingClassManager : IIssueSchedulingClassManager
    {
        private readonly IIssueSchedulingClassDataAccess DataAccess = null;
        public IssueSchedulingClassManager(IIssueSchedulingClassDataAccess dataAccess)
        {
