...
{
    public class ShipmentSummaryManager : IShipmentSummaryManager
    {
        private readonly IShipmentSummaryDataAccess DataAccess = null;
        public ShipmentSummaryManager(IShipmentSummaryDataAccess dataAccess)
        {
