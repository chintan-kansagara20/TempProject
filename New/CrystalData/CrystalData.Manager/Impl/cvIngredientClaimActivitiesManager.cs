...
{
    public class cvIngredientClaimActivitiesManager : IcvIngredientClaimActivitiesManager
    {
        private readonly IcvIngredientClaimActivitiesDataAccess DataAccess = null;
        public cvIngredientClaimActivitiesManager(IcvIngredientClaimActivitiesDataAccess dataAccess)
        {
