...
{
    public class cvProductLocationSummaryManager : IcvProductLocationSummaryManager
    {
        private readonly IcvProductLocationSummaryDataAccess DataAccess = null;
        public cvProductLocationSummaryManager(IcvProductLocationSummaryDataAccess dataAccess)
        {
