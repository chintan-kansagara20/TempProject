...
{
    public class cvInventorySerialLotSummaryTransactionsManager : IcvInventorySerialLotSummaryTransactionsManager
    {
        private readonly IcvInventorySerialLotSummaryTransactionsDataAccess DataAccess = null;
        public cvInventorySerialLotSummaryTransactionsManager(IcvInventorySerialLotSummaryTransactionsDataAccess dataAccess)
        {
