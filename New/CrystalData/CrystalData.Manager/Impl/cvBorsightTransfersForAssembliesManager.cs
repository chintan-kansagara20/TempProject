...
{
    public class cvBorsightTransfersForAssembliesManager : IcvBorsightTransfersForAssembliesManager
    {
        private readonly IcvBorsightTransfersForAssembliesDataAccess DataAccess = null;
        public cvBorsightTransfersForAssembliesManager(IcvBorsightTransfersForAssembliesDataAccess dataAccess)
        {
