...
{
    public class EDIOrdersExManager : IEDIOrdersExManager
    {
        private readonly IEDIOrdersExDataAccess DataAccess = null;
        public EDIOrdersExManager(IEDIOrdersExDataAccess dataAccess)
        {
