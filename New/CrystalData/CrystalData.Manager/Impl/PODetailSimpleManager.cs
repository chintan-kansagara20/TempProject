...
{
    public class PODetailSimpleManager : IPODetailSimpleManager
    {
        private readonly IPODetailSimpleDataAccess DataAccess = null;
        public PODetailSimpleManager(IPODetailSimpleDataAccess dataAccess)
        {
