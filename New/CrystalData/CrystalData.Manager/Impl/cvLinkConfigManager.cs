...
{
    public class cvLinkConfigManager : IcvLinkConfigManager
    {
        private readonly IcvLinkConfigDataAccess DataAccess = null;
        public cvLinkConfigManager(IcvLinkConfigDataAccess dataAccess)
        {
