...
{
    public class cvIssueViewersManager : IcvIssueViewersManager
    {
        private readonly IcvIssueViewersDataAccess DataAccess = null;
        public cvIssueViewersManager(IcvIssueViewersDataAccess dataAccess)
        {
