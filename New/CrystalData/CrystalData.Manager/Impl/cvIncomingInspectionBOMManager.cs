...
{
    public class cvIncomingInspectionBOMManager : IcvIncomingInspectionBOMManager
    {
        private readonly IcvIncomingInspectionBOMDataAccess DataAccess = null;
        public cvIncomingInspectionBOMManager(IcvIncomingInspectionBOMDataAccess dataAccess)
        {
