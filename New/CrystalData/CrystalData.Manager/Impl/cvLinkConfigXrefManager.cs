...
{
    public class cvLinkConfigXrefManager : IcvLinkConfigXrefManager
    {
        private readonly IcvLinkConfigXrefDataAccess DataAccess = null;
        public cvLinkConfigXrefManager(IcvLinkConfigXrefDataAccess dataAccess)
        {
