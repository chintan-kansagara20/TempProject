...
{
    public class ReportAccessPermissionManager : IReportAccessPermissionManager
    {
        private readonly IReportAccessPermissionDataAccess DataAccess = null;
        public ReportAccessPermissionManager(IReportAccessPermissionDataAccess dataAccess)
        {
