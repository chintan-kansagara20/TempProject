...
{
    public class ShipmentItemManager : IShipmentItemManager
    {
        private readonly IShipmentItemDataAccess DataAccess = null;
        public ShipmentItemManager(IShipmentItemDataAccess dataAccess)
        {
