...
{
    public class LocationSummaryManager : ILocationSummaryManager
    {
        private readonly ILocationSummaryDataAccess DataAccess = null;
        public LocationSummaryManager(ILocationSummaryDataAccess dataAccess)
        {
