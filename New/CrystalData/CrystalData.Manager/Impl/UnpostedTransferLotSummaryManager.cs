...
{
    public class UnpostedTransferLotSummaryManager : IUnpostedTransferLotSummaryManager
    {
        private readonly IUnpostedTransferLotSummaryDataAccess DataAccess = null;
        public UnpostedTransferLotSummaryManager(IUnpostedTransferLotSummaryDataAccess dataAccess)
        {
